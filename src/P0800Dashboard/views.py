...
def category_view(request, category_code):
    try:
        ...
        ###         -- 事業所資産額_付加価値額(マスタDB) 
        ###         SUB1.office_va_asset AS office_va_asset, 
        ###         -- 事業所被害額_営業停止に伴う損失額(マスタDB) 
        ###         SUB1.office_sus_days_lv00 AS office_sus_days_lv00, 
        ###         SUB1.office_sus_days_lv00_50 AS office_sus_days_lv00_50, 
        ###         SUB1.office_sus_days_lv50_100 AS office_sus_days_lv50_100, 
        ###         SUB1.office_sus_days_lv100_200 AS office_sus_days_lv100_200, 
        ###         -- SUB1.office_sus_days_lv200_300 AS office_sus_days_lv200_300, 
        ###         SUB1.office_sus_days_lv300 AS office_sus_days_lv300, 
        ###         -- 事業所被害額_営業停滞に伴う損失額(マスタDB) 
        ###         SUB1.office_stg_days_lv00 AS office_stg_days_lv00, 
        ###         SUB1.office_stg_days_lv00_50 AS office_stg_days_lv00_50, 
        ###         SUB1.office_stg_days_lv50_100 AS office_stg_days_lv50_100, 
        ###         SUB1.office_stg_days_lv100_200 AS office_stg_days_lv100_200, 
        ###         -- SUB1.office_stg_days_lv200_300 AS office_stg_days_lv200_300, 
        ###         SUB1.office_stg_days_lv300 AS office_stg_days_lv300, 
        ###         -- 農漁家資産額_償却資産額(マスタDB) 
        ###         SUB1.farmer_fisher_dep_asset AS farmer_fisher_dep_asset, 
        ...
        ###         -- 農漁家資産額_在庫資産額(マスタDB) 
        ###         SUB1.farmer_fisher_inv_asset AS farmer_fisher_inv_asset, 
        ...
        ###         SUB1.office_alt_lv00 AS office_alt_lv00, 
        ###         SUB1.office_alt_lv00_50 AS office_alt_lv00_50, 
        ###         SUB1.office_alt_lv50_100 AS office_alt_lv50_100, 
        ###         SUB1.office_alt_lv100_200 AS office_alt_lv100_200, 
        ###         SUB1.office_alt_lv200_300 AS office_alt_lv200_300, 
        ###         SUB1.office_alt_lv300 AS office_alt_lv300, 
        ...
        ###         CASE WHEN (SUB1.office_sus_days_lv00 * SUB1.office_va_asset) <= 0 THEN NULL ELSE (SUB1.office_sus_summary_lv00 / (SUB1.office_sus_days_lv00 * SUB1.office_va_asset)) END AS employee_lv00_reverse_office_sus_summary, 
        ###         CASE WHEN (SUB1.office_sus_days_lv00_50 * SUB1.office_va_asset) <= 0 THEN NULL ELSE (SUB1.office_sus_summary_lv01_49 / (SUB1.office_sus_days_lv00_50 * SUB1.office_va_asset)) END AS employee_lv01_49_reverse_office_sus_summary, 
        ###         CASE WHEN (SUB1.office_sus_days_lv50_100 * SUB1.office_va_asset) <= 0 THEN NULL ELSE (SUB1.office_sus_summary_lv50_99 / (SUB1.office_sus_days_lv50_100 * SUB1.office_va_asset)) END AS employee_lv50_99_reverse_office_sus_summary, 
        ###         CASE WHEN (SUB1.office_sus_days_lv100_200 * SUB1.office_va_asset) <= 0 THEN NULL ELSE (SUB1.office_sus_summary_lv100 / (SUB1.office_sus_days_lv100_200 * SUB1.office_va_asset)) END AS employee_lv100_reverse_office_sus_summary, 
        ###         -- CASE WHEN (SUB1.office_sus_days_lv200_300 * SUB1.office_va_asset) <= 0 THEN NULL ELSE (SUB1.office_sus_summary_half / (SUB1.office_sus_days_lv200_300 * SUB1.office_va_asset)) END AS employee_half_reverse_office_sus_summary, 
        ###         CASE WHEN (SUB1.office_sus_days_lv300 * SUB1.office_va_asset) <= 0 THEN NULL ELSE (SUB1.office_sus_summary_full / (SUB1.office_sus_days_lv300 * SUB1.office_va_asset)) END AS employee_full_reverse_office_sus_summary, 
        ...
        ###         CASE WHEN (SUB1.office_stg_days_lv00 * 0.5 * SUB1.office_va_asset) <= 0 THEN NULL ELSE (SUB1.office_stg_summary_lv00 / (SUB1.office_stg_days_lv00 * 0.5 * SUB1.office_va_asset)) END AS employee_lv00_reverse_office_stg_summary, 
        ###         CASE WHEN (SUB1.office_stg_days_lv00_50 * 0.5 * SUB1.office_va_asset) <= 0 THEN NULL ELSE (SUB1.office_stg_summary_lv01_49 / (SUB1.office_stg_days_lv00_50 * 0.5 * SUB1.office_va_asset)) END AS employee_lv01_49_reverse_office_stg_summary, 
        ###         CASE WHEN (SUB1.office_stg_days_lv50_100 * 0.5 * SUB1.office_va_asset) <= 0 THEN NULL ELSE (SUB1.office_stg_summary_lv50_99 / (SUB1.office_stg_days_lv50_100 * 0.5 * SUB1.office_va_asset)) END AS employee_lv50_99_reverse_office_stg_summary, 
        ###         CASE WHEN (SUB1.office_stg_days_lv100_200 * 0.5 * SUB1.office_va_asset) <= 0 THEN NULL ELSE (SUB1.office_stg_summary_lv100 / (SUB1.office_stg_days_lv100_200 * 0.5 * SUB1.office_va_asset)) END AS employee_lv100_reverse_office_stg_summary, 
        ###         -- CASE WHEN (SUB1.office_stg_days_lv200_300 * 0.5 * SUB1.office_va_asset) <= 0 THEN NULL ELSE (SUB1.office_stg_summary_half / (SUB1.office_stg_days_lv200_300 * 0.5 * SUB1.office_va_asset)) END AS employee_half_reverse_office_stg_summary, 
        ###         CASE WHEN (SUB1.office_stg_days_lv300 * 0.5 * SUB1.office_va_asset) <= 0 THEN NULL ELSE (SUB1.office_stg_summary_full / (SUB1.office_stg_days_lv300 * 0.5 * SUB1.office_va_asset)) END AS employee_full_reverse_office_stg_summary, 
        ###         -- 農漁家被害額_償却資産被害額(集計DB) 
        ...
        ###         CASE WHEN (SUB1.farmer_fisher_dep_asset * SUB1.farmer_fisher_dep_rate_lv00) <= 0 THEN NULL ELSE (SUB1.farmer_fisher_dep_summary_lv00 / (SUB1.farmer_fisher_dep_asset * SUB1.farmer_fisher_dep_rate_lv00)) END AS farmer_fisher_lv00_reverse_farmer_fisher_dep_summary, 
        ###         CASE WHEN (SUB1.farmer_fisher_dep_asset * SUB1.farmer_fisher_dep_rate_lv00_50) <= 0 THEN NULL ELSE (SUB1.farmer_fisher_dep_summary_lv01_49 / (SUB1.farmer_fisher_dep_asset * SUB1.farmer_fisher_dep_rate_lv00_50)) END AS farmer_fisher_lv01_49_reverse_farmer_fisher_dep_summary, 
        ###         CASE WHEN (SUB1.farmer_fisher_dep_asset * SUB1.farmer_fisher_dep_rate_lv50_100) <= 0 THEN NULL ELSE (SUB1.farmer_fisher_dep_summary_lv50_99 / (SUB1.farmer_fisher_dep_asset * SUB1.farmer_fisher_dep_rate_lv50_100)) END AS farmer_fisher_lv50_99_reverse_farmer_fisher_dep_summary, 
        ###         CASE WHEN (SUB1.farmer_fisher_dep_asset * SUB1.farmer_fisher_dep_rate_lv100_200) <= 0 THEN NULL ELSE (SUB1.farmer_fisher_dep_summary_lv100 / (SUB1.farmer_fisher_dep_asset * SUB1.farmer_fisher_dep_rate_lv100_200)) END AS farmer_fisher_lv100_reverse_farmer_fisher_dep_summary, 
        ###         -- CASE WHEN (SUB1.farmer_fisher_dep_asset * SUB1.farmer_fisher_dep_rate_lv200_300) <= 0 THEN NULL ELSE (SUB1.farmer_fisher_dep_summary_half / (SUB1.farmer_fisher_dep_asset * SUB1.farmer_fisher_dep_rate_lv200_300)) END AS farmer_fisher_half_reverse_farmer_fisher_dep_summary, 
        ###         CASE WHEN (SUB1.farmer_fisher_dep_asset * SUB1.farmer_fisher_dep_rate_lv300) <= 0 THEN NULL ELSE (SUB1.farmer_fisher_dep_summary_full / (SUB1.farmer_fisher_dep_asset * SUB1.farmer_fisher_dep_rate_lv300)) END AS farmer_fisher_full_reverse_farmer_fisher_dep_summary, 
        ###         -- 農漁家被害額_在庫資産被害額(集計DB) 
        ...
        ###         CASE WHEN (SUB1.farmer_fisher_inv_asset * SUB1.farmer_fisher_inv_rate_lv00) <= 0 THEN NULL ELSE (SUB1.farmer_fisher_inv_summary_lv00 / (SUB1.farmer_fisher_inv_asset * SUB1.farmer_fisher_inv_rate_lv00)) END AS farmer_fisher_lv00_reverse_farmer_fisher_inv_summary, 
        ###         CASE WHEN (SUB1.farmer_fisher_inv_asset * SUB1.farmer_fisher_inv_rate_lv00_50) <= 0 THEN NULL ELSE (SUB1.farmer_fisher_inv_summary_lv01_49 / (SUB1.farmer_fisher_inv_asset * SUB1.farmer_fisher_inv_rate_lv00_50)) END AS farmer_fisher_lv01_49_reverse_farmer_fisher_inv_summary, 
        ###         CASE WHEN (SUB1.farmer_fisher_inv_asset * SUB1.farmer_fisher_inv_rate_lv50_100) <= 0 THEN NULL ELSE (SUB1.farmer_fisher_inv_summary_lv50_99 / (SUB1.farmer_fisher_inv_asset * SUB1.farmer_fisher_inv_rate_lv50_100)) END AS farmer_fisher_lv50_99_reverse_farmer_fisher_inv_summary, 
        ###         CASE WHEN (SUB1.farmer_fisher_inv_asset * SUB1.farmer_fisher_inv_rate_lv100_200) <= 0 THEN NULL ELSE (SUB1.farmer_fisher_inv_summary_lv100 / (SUB1.farmer_fisher_inv_asset * SUB1.farmer_fisher_inv_rate_lv100_200)) END AS farmer_fisher_lv100_reverse_farmer_fisher_inv_summary, 
        ###         -- CASE WHEN (SUB1.farmer_fisher_inv_asset * SUB1.farmer_fisher_inv_rate_lv200_300) <= 0 THEN NULL ELSE (SUB1.farmer_fisher_inv_summary_half / (SUB1.farmer_fisher_inv_asset * SUB1.farmer_fisher_inv_rate_lv200_300)) END AS farmer_fisher_half_reverse_farmer_fisher_inv_summary, 
        ###         CASE WHEN (SUB1.farmer_fisher_inv_asset * SUB1.farmer_fisher_inv_rate_lv300) <= 0 THEN NULL ELSE (SUB1.farmer_fisher_inv_summary_full / (SUB1.farmer_fisher_inv_asset * SUB1.farmer_fisher_inv_rate_lv300)) END AS farmer_fisher_full_reverse_farmer_fisher_inv_summary, 
        ###         -- 事業所応急対策費_代替活動費(集計DB) 
        ...
        ###         CASE WHEN (SUB1.office_alt_lv00) <= 0 THEN NULL ELSE (SUB1.office_alt_summary_lv00 / SUB1.office_alt_lv00) END AS office_lv00_reverse_office_alt_summary, 
        ###         CASE WHEN (SUB1.office_alt_lv00_50) <= 0 THEN NULL ELSE (SUB1.office_alt_summary_lv01_49 / SUB1.office_alt_lv00_50) END AS office_lv01_49_reverse_office_alt_summary, 
        ###         CASE WHEN (SUB1.office_alt_lv50_100) <= 0 THEN NULL ELSE (SUB1.office_alt_summary_lv50_99 / SUB1.office_alt_lv50_100) END AS office_lv50_99_reverse_office_alt_summary, 
        ###         CASE WHEN (SUB1.office_alt_lv100_200) <= 0 THEN NULL ELSE (SUB1.office_alt_summary_lv100 / SUB1.office_alt_lv100_200) END AS office_lv100_reverse_office_alt_summary, 
        ###         -- CASE WHEN (SUB1.office_alt_lv200_300) <= 0 THEN NULL ELSE (SUB1.office_alt_summary_half / SUB1.office_alt_lv200_300) END AS office_half_reverse_office_alt_summary, 
        ###         CASE WHEN (SUB1.office_alt_lv300) <= 0 THEN NULL ELSE (SUB1.office_alt_summary_full / SUB1.office_alt_lv300) END AS office_full_reverse_office_alt_summary 
        ###     FROM 
        ###     (
        ###         SELECT 
