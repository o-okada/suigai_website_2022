...
def index_view(request):
    try:
        ...
        #######################################################################
        print_log('[INFO] ########################################', 'INFO')
        print_log('[INFO] P0800Reverse.index_view()関数が開始しました。', 'INFO')
        print_log('[INFO] P0800Reverse.index_view()関数 request = {}'.format(request.method), 'INFO')
        print_log('[INFO] P0800Reverse.index_view()関数 STEP 1/2.', 'INFO')

        #######################################################################
        ### レスポンスセット処理(0010)
        ### (1)テンプレートとコンテキストを設定して、レスポンスをブラウザに戻す。
        #######################################################################
        print_log('[INFO] P0800Reverse.index_view()関数 STEP 2/2.', 'INFO')
        template = loader.get_template('P0800Reverse/index.html')
        context = {}
        print_log('[INFO] P0800Reverse.index_view()関数が正常終了しました。', 'INFO')
        return HttpResponse(template.render(context, request))
    
    except:
        print_log(sys.exc_info()[0], 'ERROR')
        print_log('[ERROR] P0800Reverse.index_view()関数でエラーが発生しました。', 'ERROR')
        print_log('[ERROR] P0800Reverse.index_view()関数が異常終了しました。', 'ERROR')
...
def category_view(request, category_code):
    try:
        ...
        #######################################################################
        print_log('[INFO] ########################################', 'INFO')
        print_log('[INFO] P0800Reverse.category_view()関数が開始しました。', 'INFO')
        print_log('[INFO] P0800Reverse.category_view()関数 request = {}'.format(request.method), 'INFO')
        print_log('[INFO] P0800Reverse.category_view()関数 category_code = {}'.format(category_code), 'INFO')
        print_log('[INFO] P0800Reverse.category_view()関数 STEP 1/6.', 'INFO')
        ...
        #######################################################################
        print_log('[INFO] P0800Reverse.category_view()関数 STEP 2/6.', 'INFO')
        ...
        ####################################################################### 
        print_log('[INFO] P0800Reverse.category_view()関数 STEP 4/6.', 'INFO')
        ...
        print_log('[INFO] P0800Reverse.category_view()関数 STEP 5/6.', 'INFO')
        ...
        ### (1)テンプレートとコンテキストを設定して、レスポンスをブラウザに戻す。
        #######################################################################
        print_log('[INFO] P0800Reverse.category_view()関数 STEP 6/6.', 'INFO')
        template = loader.get_template('P0800Reverse/index.html')
        context = {
        ...
        print_log('[INFO] P0800Reverse.category_view()関数が正常終了しました。', 'INFO')
        return HttpResponse(template.render(context, request))
    
    except:
        print_log(sys.exc_info()[0], 'ERROR')
        print_log('[ERROR] P0800Reverse.category_view()関数でエラーが発生しました。', 'ERROR')
        print_log('[ERROR] P0800Reverse.category_view()関数が異常終了しました。', 'ERROR')
        return render(request, 'error.html')
