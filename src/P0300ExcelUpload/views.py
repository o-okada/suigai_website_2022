...
def index_view(request):
    try:
        ...
        check_correlate_list = []                                                   ### 相関チェック結果を格納するリスト
        check_compare_list = []                                                     ### 突合チェック結果を格納するリスト
        check_require_grid = []                                                     ### 必須チェック結果を格納するリスト
        check_format_grid = []                                                      ### 形式チェック結果を格納するリスト
        check_range_grid = []                                                       ### 範囲チェック結果を格納するリスト
        check_correlate_grid = []                                                   ### 相関チェック結果を格納するリスト
        check_compare_grid = []                                                     ### 突合チェック結果を格納するリスト
        ...
        wb.move_sheet('CHECK_RESULT', offset=-wb.index(ws_copy))
        wb.move_sheet('CHECK_RESULT', offset=1)
        ...
        if ws_max_row >= 20:
            for i in range(20, ws_max_row + 1):
                if ws.cell(row=i, column=2).value is None:                          ### COL2: 町丁名・大字名
                ...
                if ws.cell(row=i, column=3).value is None:                          ### COL3: 名称
                ...
                if ws.cell(row=i, column=4).value is None:                          ### COL4: 地上・地下被害の区分
                ...
                if ws.cell(row=i, column=5).value is None:                          ### COL5: 浸水土砂被害の区分
                ...
                if ws.cell(row=i, column=6).value is None:                          ### COL6: 被害建物棟数, 床下浸水
                ...
                if ws.cell(row=i, column=7).value is None:                          ### COL7: 被害建物棟数, 1cm〜49cm
                ...
                if ws.cell(row=i, column=8).value is None:                          ### COL8: 被害建物棟数, 50cm〜99cm
                ...
                if ws.cell(row=i, column=9).value is None:                          ### COL9: 被害建物棟数, 1m以上
                ...
                if ws.cell(row=i, column=10).value is None:                         ### COL10: 被害建物棟数, 半壊
                ...
                if ws.cell(row=i, column=11).value is None:                         ### COL11: 被害建物棟数, 全壊・流失
                ...
                if ws.cell(row=i, column=12).value is None:                         ### COL12: 被害建物の延床面積
                ...
                if ws.cell(row=i, column=13).value is None:                         ### COL13: 被災世帯数
                ...
                if ws.cell(row=i, column=14).value is None:                         ### COL14: 被災事業所数
                ...
                if ws.cell(row=i, column=15).value is None:                         ### COL15: 農家・漁家戸数, 床下浸水
                ...
                if ws.cell(row=i, column=16).value is None:                         ### COL16: 農家・漁家戸数, 1cm〜49cm
        ...
        if ws.cell(row=7, column=9).value is None:                                  ### 水害区域番号
            ...
            if isinstance(ws.cell(row=7, column=9).value, int) == False:
        ...
        if ws.cell(row=14, column=2).value is None:                                 ### 水害区域面積の宅地
            ...
            if isinstance(ws.cell(row=14, column=2).value, int) == False and \
                isinstance(ws.cell(row=14, column=2).value, float) == False:
        ...
        if ws.cell(row=14, column=3).value is None:                                 ### 水害区域面積の農地
            ...
            if isinstance(ws.cell(row=14, column=3).value, int) == False and \
                isinstance(ws.cell(row=14, column=3).value, float) == False:
        ...
        if ws.cell(row=14, column=4).value is None:                                 ### 水害区域面積の地下
            ...
            if isinstance(ws.cell(row=14, column=4).value, int) == False and \
                isinstance(ws.cell(row=14, column=4).value, float) == False:
        ...
        if ws.cell(row=14, column=8).value is None:                                 ### 農作物被害額
            ...
            if isinstance(ws.cell(row=14, column=8).value, int) == False and \
                isinstance(ws.cell(row=14, column=8).value, float) == False:
        ...
        if ws.cell(row=14, column=10).value is None:                                ### 異常気象コード
            ...
            if isinstance(ws.cell(row=14, column=10).value, int) == False:
            ...
            for i in range(20, ws_max_row + 1):
                ...
                if ws.cell(row=i, column=6).value is None:                          ### COL6: 被害建物棟数, 床下浸水
                    ...
                    if isinstance(ws.cell(row=i, column=6).value, int) == False and \
                        isinstance(ws.cell(row=i, column=6).value, float) == False:
                ...
                if ws.cell(row=i, column=7).value is None:                          ### COL7: 被害建物棟数, 1cm〜49cm
                    ...
                    if isinstance(ws.cell(row=i, column=7).value, int) == False and \
                        isinstance(ws.cell(row=i, column=7).value, float) == False:
                ...
                if ws.cell(row=i, column=8).value is None:                          ### COL8: 被害建物棟数, 50cm〜99cm
                    ...
                    if isinstance(ws.cell(row=i, column=8).value, int) == False and \
                        isinstance(ws.cell(row=i, column=8).value, float) == False:
                ...
                if ws.cell(row=i, column=9).value is None:                          ### COL9: 被害建物棟数, 1m以上
                    ...
                    if isinstance(ws.cell(row=i, column=9).value, int) == False and \
                        isinstance(ws.cell(row=i, column=9).value, float) == False:
                ...
                if ws.cell(row=i, column=10).value is None:                         ### COL10: 被害建物棟数, 半壊
                    ...
                    if isinstance(ws.cell(row=i, column=10).value, int) == False and \
                        isinstance(ws.cell(row=i, column=10).value, float) == False:
                ...
                if ws.cell(row=i, column=11).value is None:                         ### COL11: 被害建物棟数, 全壊・流失
                    ...
                    if isinstance(ws.cell(row=i, column=11).value, int) == False and \
                        isinstance(ws.cell(row=i, column=11).value, float) == False:
                ...
                if ws.cell(row=i, column=12).value is None:                         ### COL12: 被害建物の延床面積
                    ...
                    if isinstance(ws.cell(row=i, column=12).value, int) == False and \
                        isinstance(ws.cell(row=i, column=12).value, float) == False:
                ...
                if ws.cell(row=i, column=13).value is None:                         ### COL13: 被災世帯数
                    ...
                    if isinstance(ws.cell(row=i, column=13).value, int) == False and \
                        isinstance(ws.cell(row=i, column=13).value, float) == False:
                ...
                if ws.cell(row=i, column=14).value is None:                         ### COL14: 被災事業所数
                    ...
                    if isinstance(ws.cell(row=i, column=14).value, int) == False and \
                        isinstance(ws.cell(row=i, column=14).value, float) == False:
                ...
                if ws.cell(row=i, column=15).value is None:                         ### COL15: 農家・漁家戸数, 床下浸水
                    ...
                    if isinstance(ws.cell(row=i, column=15).value, int) == False and \
                        isinstance(ws.cell(row=i, column=15).value, float) == False:
                ...
                if ws.cell(row=i, column=16).value is None:                         ### COL16: 農家・漁家戸数, 1cm〜49cm
                    ...
                    if isinstance(ws.cell(row=i, column=16).value, int) == False and \
                        isinstance(ws.cell(row=i, column=16).value, float) == False:
                ...
                if ws.cell(row=i, column=17).value is None:                         ### COL17: 農家・漁家戸数, 50cm〜99cm
                    ...
                    if isinstance(ws.cell(row=i, column=17).value, int) == False and \
                        isinstance(ws.cell(row=i, column=17).value, float) == False:
                ...
                if ws.cell(row=i, column=18).value is None:                         ### COL18: 農家・漁家戸数, 1m以上・半壊
                    ...
                    if isinstance(ws.cell(row=i, column=18).value, int) == False and \
                        isinstance(ws.cell(row=i, column=18).value, float) == False:
                ...
                if ws.cell(row=i, column=19).value is None:                         ### COL19: 農家・漁家戸数, 全壊・流失
                    ...
                    if isinstance(ws.cell(row=i, column=19).value, int) == False and \
                        isinstance(ws.cell(row=i, column=19).value, float) == False:
                ...
                if ws.cell(row=i, column=20).value is None:                         ### COL20: 事業所従業者数, 床下浸水
                    ...
                    if isinstance(ws.cell(row=i, column=20).value, int) == False and \
                        isinstance(ws.cell(row=i, column=20).value, float) == False:
                ...
                if ws.cell(row=i, column=21).value is None:                         ### COL21: 事業所従業者数, 1cm〜49cm
                    ...
                    if isinstance(ws.cell(row=i, column=21).value, int) == False and \
                        isinstance(ws.cell(row=i, column=21).value, float) == False:
                ...
                if ws.cell(row=i, column=22).value is None:                         ### COL22: 事業所従業者数, 50cm〜99cm
                    ...
                    if isinstance(ws.cell(row=i, column=22).value, int) == False and \
                        isinstance(ws.cell(row=i, column=22).value, float) == False:
                ...
                if ws.cell(row=i, column=23).value is None:                         ### COL23: 事業所従業者数, 1m以上・半壊
                    ...
                    if isinstance(ws.cell(row=i, column=23).value, int) == False and \
                        isinstance(ws.cell(row=i, column=23).value, float) == False:
                ...
                if ws.cell(row=i, column=24).value is None:                         ### COL24: 事業所従業者数, 全壊・流失
                    ...
                    if isinstance(ws.cell(row=i, column=24).value, int) == False and \
                        isinstance(ws.cell(row=i, column=24).value, float) == False:
        ...
        ### 7行目
        ### if ws.cell(row=7, column=2).value is None:                              ### 都道府県
        ###     check_range_list.append([7, 2, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ### if ws.cell(row=7, column=3).value is None:                              ### 市区町村
        ###     check_range_list.append([7, 3, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ### if ws.cell(row=7, column=4).value is None:                              ### 水害発生月日
        ###     check_range_list.append([7, 4, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ### if ws.cell(row=7, column=5).value is None:                              ### 水害終了月日
        ###     check_range_list.append([7, 5, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ...
        if ws.cell(row=7, column=7).value is None:                                  ### 水害原因2
            ...
            if ws.cell(row=7, column=7).value == '10' or ws.cell(row=7, column=7).value == '破堤' or \
        ...
        if ws.cell(row=7, column=8).value is None:                                  ### 水害原因3
            ...
            if ws.cell(row=7, column=8).value == '10' or ws.cell(row=7, column=8).value == '破堤' or \
        ...
        if ws.cell(row=7, column=9).value is None:                                  ### 水害区域番号
            ...
            if isinstance(ws.cell(row=7, column=9).value, int) == True or \
                isinstance(ws.cell(row=7, column=9).value, float) == True:
                if float(ws.cell(row=7, column=9).value) < 0:
        ...
        ### 10行目
        ### if ws.cell(row=10, column=2).value is None:                             ### 水系・沿岸名
        ###     check_range_list.append([10, 2, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ...
        ### if ws.cell(row=10, column=4).value is None:                             ### 河川・海岸名
        ###     check_range_list.append([10, 4, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ...
        if ws.cell(row=14, column=2).value is None:                                 ### 水害区域面積の宅地
            ...
            if isinstance(ws.cell(row=14, column=2).value, int) == True or \
                isinstance(ws.cell(row=14, column=2).value, float) == True:
                if float(ws.cell(row=14, column=2).value) < 0:
        ...
        if ws.cell(row=14, column=3).value is None:                                 ### 水害区域面積の農地
            ...
            if isinstance(ws.cell(row=14, column=3).value, int) == True or \
                isinstance(ws.cell(row=14, column=3).value, float) == True:
                if float(ws.cell(row=14, column=3).value) < 0:
        ...
        if ws.cell(row=14, column=4).value is None:                                 ### 水害区域面積の地下
            ...
            if isinstance(ws.cell(row=14, column=4).value, int) == True or \
                isinstance(ws.cell(row=14, column=4).value, float) == True:
                if float(ws.cell(row=14, column=4).value) < 0:
        ...
        if ws.cell(row=14, column=8).value is None:                                 ### 農作物被害額
            ...
            if isinstance(ws.cell(row=14, column=8).value, int) == True or \
                isinstance(ws.cell(row=14, column=8).value, float) == True:
                if float(ws.cell(row=14, column=8).value) < 0:
        ...
        if ws.cell(row=14, column=10).value is None:                                ### 異常気象コード
            ...
            if isinstance(ws.cell(row=14, column=10).value, int) == True or \
                isinstance(ws.cell(row=14, column=10).value, float) == True:
                if float(ws.cell(row=14, column=10).value) < 0:
        ...
        if ws_max_row >= 20:
            for i in range(20, ws_max_row + 1):
                ### if ws.cell(row=i, column=2).value is None:                      ### COL2: 町丁名・大字名
                ###     check_range_grid.append([i, 2, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
                ### if ws.cell(row=i, column=3).value is None:                      ### COL3: 名称
                ###     check_range_grid.append([i, 3, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
                ...
                if ws.cell(row=i, column=6).value is None:                          ### COL6: 被害建物棟数, 床下浸水
                    ...
                    if isinstance(ws.cell(row=i, column=6).value, int) == True or \
                ...
                if ws.cell(row=i, column=7).value is None:                          ### COL7: 被害建物棟数, 1cm〜49cm
                    ...
                    if isinstance(ws.cell(row=i, column=7).value, int) == True or \
                ...
                if ws.cell(row=i, column=8).value is None:                          ### COL8: 被害建物棟数, 50cm〜99cm
                    ...
                    if isinstance(ws.cell(row=i, column=8).value, int) == True or \
                ...
                if ws.cell(row=i, column=9).value is None:                          ### COL9: 被害建物棟数, 1m以上
                    ...
                    if isinstance(ws.cell(row=i, column=9).value, int) == True or \
                ...
                if ws.cell(row=i, column=10).value is None:                         ### COL10: 被害建物棟数, 半壊
                    ...
                    if isinstance(ws.cell(row=i, column=10).value, int) == True or \
                ...
                if ws.cell(row=i, column=11).value is None:                         ### COL11: 被害建物棟数, 全壊・流失
                    ...
                    if isinstance(ws.cell(row=i, column=11).value, int) == True or \
                ...
                if ws.cell(row=i, column=12).value is None:                         ### COL12: 被害建物の延床面積
                    ...
                    if isinstance(ws.cell(row=i, column=12).value, int) == True or \
                ...
                if ws.cell(row=i, column=13).value is None:                         ### COL13: 被災世帯数
                    ...
                    if isinstance(ws.cell(row=i, column=13).value, int) == True or \
                ...
                if ws.cell(row=i, column=14).value is None:                         ### COL14: 被災事業所数
                    ...
                    if isinstance(ws.cell(row=i, column=14).value, int) == True or \
                ...
                if ws.cell(row=i, column=15).value is None:                         ### COL15: 農家・漁家戸数, 床下浸水
                    ...
                    if isinstance(ws.cell(row=i, column=15).value, int) == True or \
                ...
                if ws.cell(row=i, column=16).value is None:                         ### COL16: 農家・漁家戸数, 1cm〜49cm
                    ...
                    if isinstance(ws.cell(row=i, column=16).value, int) == True or \
                ...
                if ws.cell(row=i, column=17).value is None:                         ### COL17: 農家・漁家戸数, 50cm〜99cm
                    ...
                    if isinstance(ws.cell(row=i, column=17).value, int) == True or \
                ...
                if ws.cell(row=i, column=18).value is None:                         ### COL18: 農家・漁家戸数, 1m以上・半壊
                    ...
                    if isinstance(ws.cell(row=i, column=18).value, int) == True or \
                ...
                if ws.cell(row=i, column=19).value is None:                         ### COL19: 農家・漁家戸数, 全壊・流失
                    ...
                    if isinstance(ws.cell(row=i, column=19).value, int) == True or \
                ...
                if ws.cell(row=i, column=20).value is None:                         ### COL20: 事業所従業者数, 床下浸水
                    ...
                    if isinstance(ws.cell(row=i, column=20).value, int) == True or \
                ...
                if ws.cell(row=i, column=21).value is None:                         ### COL21: 事業所従業者数, 1cm〜49cm
                    ...
                    if isinstance(ws.cell(row=i, column=21).value, int) == True or \
                ...
                if ws.cell(row=i, column=22).value is None:                         ### COL22: 事業所従業者数, 50cm〜99cm
                    ...
                    if isinstance(ws.cell(row=i, column=22).value, int) == True or \
                ...
                if ws.cell(row=i, column=23).value is None:                         ### COL23: 事業所従業者数, 1m以上・半壊
                    ...
                    if isinstance(ws.cell(row=i, column=23).value, int) == True or \
                ...
                if ws.cell(row=i, column=24).value is None:                         ### COL24: 事業所従業者数, 全壊・流失
                    ...
                    if isinstance(ws.cell(row=i, column=24).value, int) == True or \
                ...
                if ws.cell(row=i, column=25).value is None:                         ### COL25: 事業所の産業区分
                    ...
                    if ws.cell(row=i, column=25).value == '1' or ws.cell(row=i, column=25).value == '鉱業、採石業、砂利採取業' or \
                ...
                if ws.cell(row=i, column=26).value is None:                         ### COL26: 地下空間の利用形態
                    ...
                    if ws.cell(row=i, column=26).value == '1' or ws.cell(row=i, column=26).value == '住居' or \
                ...
                ### if ws.cell(row=i, column=27).value is None:                     ### COL27: 備考
                ###     check_range_grid.append([i, 27, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ...
        ### TO-DO: 
        ### if ws.cell(row=7, column=2).value is None:                              ### 都道府県
        ###     check_correlate_list.append([7, 2, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ### if ws.cell(row=7, column=3).value is None:                              ### 市区町村
        ###     check_correlate_list.append([7, 3, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ### 都道府県名に対して無効な市区町村名が入力されていないか。
        ### if ws.cell(row=7, column=4).value is None:                              ### 水害発生月日
        ###     check_correlate_list.append([7, 4, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ### if ws.cell(row=7, column=5).value is None:                              ### 水害終了月日
        ###     check_correlate_list.append([7, 5, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ### 水害発生月日に対して無効な水害終了月日が入力されていないか。
        ### if ws.cell(row=7, column=6).value is None:                              ### 水害原因1
        ###     check_correlate_list.append([7, 6, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ### if ws.cell(row=7, column=7).value is None:                              ### 水害原因2
        ###     check_correlate_list.append([7, 7, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ### if ws.cell(row=7, column=8).value is None:                              ### 水害原因3
        ###     check_correlate_list.append([7, 8, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ### if ws.cell(row=7, column=9).value is None:                              ### 水害区域番号
        ###     check_correlate_list.append([7, 9, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
    
        ### 10行目
        ### TO-DO: 
        ### if ws.cell(row=10, column=2).value is None:                             ### 水系・沿岸名
        ###     check_correlate_list.append([10, 2, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ### 水系種別に対して無効な水系・沿岸名が入力されていないか。
        ### 水系・沿岸名に無名水系以外の水系に対して、無効な水系の文字が含まれていないか。
        ### if ws.cell(row=10, column=3).value is None:                             ### 水系種別
        ###     check_correlate_list.append([10, 3, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ### if ws.cell(row=10, column=4).value is None:                             ### 河川・海岸名
        ###     check_correlate_list.append([10, 4, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ### if ws.cell(row=10, column=5).value is None:                             ### 河川種別
        ###     check_correlate_list.append([10, 5, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ...
        ### if ws.cell(row=10, column=6).value is None:                             ### 地盤勾配区分
        ###     check_correlate_list.append([10, 6, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
    
        ### 14行目
        ### TO-DO: 
        ### if ws.cell(row=14, column=2).value is None:                             ### 水害区域面積の宅地
        ###     check_correlate_list.append([14, 2, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ### if ws.cell(row=14, column=3).value is None:                             ### 水害区域面積の農地
        ###     check_correlate_list.append([14, 3, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ### if ws.cell(row=14, column=4).value is None:                             ### 水害区域面積の地下
        ###     check_correlate_list.append([14, 4, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ...
        ### if ws.cell(row=14, column=6).value is None:                             ### 工種
        ###     check_correlate_list.append([14, 6, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
        ...
        if ws.cell(row=14, column=3).value is None:
            pass
        else:
            if ws.cell(row=14, column=8).value is None:
        ...
        ### if ws.cell(row=14, column=10).value is None:                            ### 異常気象コード
        ###     check_correlate_list.append([14, 10, MESSAGE[][0], MESSAGE[][1], MESSAGE[][2], MESSAGE[][3], MESSAGE[][4]])
