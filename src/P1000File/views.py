...
def index_view(request):
    try:
        ...
        #######################################################################
        print_log('[INFO] ########################################', 'INFO')
        print_log('[INFO] P1000File.index_view()関数が開始しました。', 'INFO')
        print_log('[INFO] P1000File.index_view()関数 request = {}'.format(request.method), 'INFO')
        print_log('[INFO] P1000File.index_view()関数 STEP 1/3.', 'INFO')
        
        #######################################################################
        ### DBアクセス処理(0010)
        ### DBにアクセスして、データを取得する。
        #######################################################################
        print_log('[INFO] P1000File.index_view()関数 STEP 2/3.', 'INFO')
        ...
        #######################################################################
        print_log('[INFO] P1000File.index_view()関数 STEP 3/3.', 'INFO')
        template = loader.get_template('P1000File/index.html')
        context = {
            'repository_list': repository_list, 
        }
        print_log('[INFO] P1000File.index_view()関数が正常終了しました。', 'INFO')
        return HttpResponse(template.render(context, request))
    
    except:
        print_log(sys.exc_info()[0], 'ERROR')
        print_log('[ERROR] P1000File.index_view()関数でエラーが発生しました。', 'ERROR')
        print_log('[ERROR] P1000File.index_view()関数が異常終了しました。', 'ERROR')
...
def R4_view(request):
    try:
        ...
        #######################################################################
        print_log('[INFO] ########################################', 'INFO')
        print_log('[INFO] P1000File.R4_view()関数が開始しました。', 'INFO')
        print_log('[INFO] P1000File.R4_view()関数 request = {}'.format(request.method), 'INFO')
        print_log('[INFO] P1000File.R4_view()関数 STEP 1/3.', 'INFO')
        
        #######################################################################
        ### DBアクセス処理(0010)
        ### DBにアクセスして、データを取得する。
        #######################################################################
        print_log('[INFO] P1000File.R4_view()関数 STEP 2/3.', 'INFO')
        ...
        ### テンプレートとコンテキストを設定して、レスポンスをブラウザに戻す。
        #######################################################################
        print_log('[INFO] P1000File.R4_view()関数 STEP 3/3.', 'INFO')
        template = loader.get_template('P1000File/R4_index.html')
        context = {
            'ken_list': ken_list, 
        ...
        print_log('[INFO] P1000File.R4_view()関数が正常終了しました。', 'INFO')
        return HttpResponse(template.render(context, request))
    
    except:
        print_log(sys.exc_info()[0], 'ERROR')
        print_log('[ERROR] P1000File.R4_view()関数でエラーが発生しました。', 'ERROR')
        print_log('[ERROR] P1000File.R4_view()関数が異常終了しました。', 'ERROR')
        return render(request, 'error.html')
...
def R4_ken_view(request, ken_code):
    try:
        ...
        #######################################################################
        print_log('[INFO] ########################################', 'INFO')
        print_log('[INFO] P1000File.R4_ken_view()関数が開始しました。', 'INFO')
        print_log('[INFO] P1000File.R4_ken_view()関数 request = {}'.format(request.method), 'INFO')
        print_log('[INFO] P1000File.R4_ken_view()関数 ken_code = {}'.format(ken_code), 'INFO')
        print_log('[INFO] P1000File.R4_ken_view()関数 STEP 1/3.', 'INFO')
        
        #######################################################################
        ### DBアクセス処理(0010)
        ### DBにアクセスして、データを取得する。
        #######################################################################
        print_log('[INFO] P1000File.R4_ken_view()関数 STEP 2/3.', 'INFO')
        ...
        ### テンプレートとコンテキストを設定して、レスポンスをブラウザに戻す。
        #######################################################################
        print_log('[INFO] P1000File.R4_ken_view()関数 STEP 3/3.', 'INFO')
        template = loader.get_template('P1000File/R4_ken.html')
        context = {
            'ken_list': ken_list, 
            'repository_list': repository_list, 
        }
        print_log('[INFO] P1000File.R4_ken_view()関数が正常終了しました。', 'INFO')
        return HttpResponse(template.render(context, request))
    
    except:
        print_log(sys.exc_info()[0], 'ERROR')
        print_log('[ERROR] P1000File.R4_ken_view()関数でエラーが発生しました。', 'ERROR')
        print_log('[ERROR] P1000File.R4_ken_view()関数が異常終了しました。', 'ERROR')
        return render(request, 'error.html')
