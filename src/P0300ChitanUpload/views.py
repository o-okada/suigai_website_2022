...
MESSAGE.append([0, 'W0000', '必須', 'NO.が入力されていません。', 'NO.を入力してください。'])                    ### 列1
MESSAGE.append([1, 'W0001', '必須', '水系・沿岸名が入力されていません。', '水系・沿岸名を入力してください。'])  ### 列2
MESSAGE.append([2, 'W0002', '必須', '水系種別が入力されていません。', '水系種別を入力してください。'])          ### 列3
MESSAGE.append([3, 'W0003', '必須', '河川・海岸名が入力されていません。', '河川・海岸名を入力してください。'])
MESSAGE.append([4, 'W0004', '必須', '河川種別が入力されていません。', '河川種別を入力してください。'])
MESSAGE.append([5, 'W0005', '必須', '代表被災地区名が入力されていません。', '代表被災地区名を入力してください。'])
MESSAGE.append([6, 'W0006', '必須', '都道府県名が入力されていません。', '都道府県名を入力してください。'])
MESSAGE.append([7, 'W0007', '必須', '市区町村名が入力されていません。', '市区町村名を入力してください。'])
MESSAGE.append([8, 'W0008', '必須', '都道府県コードが入力されていません。', '都道府県コードを入力してください。'])
MESSAGE.append([9, 'W0009', '必須', '', ''])
MESSAGE.append([10, 'W0010', '必須', '異常気象コードが入力されていません。', '異常気象コードを入力してください。'])
MESSAGE.append([11, 'W0011', '必須', '水害発生開始月が入力されていません。', '水害発生開始月を入力してください。'])
MESSAGE.append([12, 'W0012', '必須', '水害発生開始日が入力されていません。', '水害発生開始日を入力してください。'])
MESSAGE.append([13, 'W0013', '必須', '水害発生終了月が入力されていません。', '水害発生終了月を入力してください。'])
MESSAGE.append([14, 'W0014', '必須', '水害発生終了日が入力されていません。', '水害発生終了日を入力してください。'])
MESSAGE.append([15, 'W0015', '必須', '工種区分が入力されていません。', '工種区分を入力してください。'])
MESSAGE.append([16, 'W0016', '必須', '', ''])
MESSAGE.append([17, 'W0017', '必須', '市区町村コードが入力されていません。', '市区町村コードを入力してください。'])
MESSAGE.append([18, 'W0018', '必須', '災害復旧箇所が入力されていません。', '災害復旧箇所を入力してください。'])
MESSAGE.append([19, 'W0019', '必須', '災害復旧査定額(千円)が入力されていません。', '災害復旧査定額(千円)を入力してください。'])
MESSAGE.append([20, 'W0020', '必須', '備考が入力されていません。', '備考を入力してください。'])
...
### 形式チェックのメッセージを定義する。
###############################################################################
MESSAGE.append([100, 'W0100', '形式', 'NO.に無効な文字が入力されています。', '半角数字の形式で入力してください。'])                   ### 列1
MESSAGE.append([101, 'W0101', '形式', '水系・沿岸名に無効な文字が入力されています。', '全角文字:半角数字の形式で入力してください。']) ### 列2
MESSAGE.append([102, 'W0102', '形式', '水系種別に無効な文字が入力されています。', '全角文字:半角数字の形式で入力してください。'])     ### 列3
MESSAGE.append([103, 'W0103', '形式', '河川・海岸名に無効な文字が入力されています。', '全角文字:半角数字の形式で入力してください。'])
MESSAGE.append([104, 'W0104', '形式', '河川種別に無効な文字が入力されています。', '全角文字:半角数字の形式で入力してください。'])
MESSAGE.append([105, 'W0105', '形式', '代表被災地区名に無効な文字が入力されています。', '全角文字の形式で入力してください。'])
MESSAGE.append([106, 'W0106', '形式', '都道府県名に無効な文字が入力されています。', '全角文字:半角数字の形式で入力してください。'])
MESSAGE.append([107, 'W0107', '形式', '市区町村名に無効な文字が入力されています。', '全角文字:半角数字の形式で入力してください。'])
MESSAGE.append([108, 'W0108', '形式', '都道府県コードに無効な文字が入力されています。', '全角文字:半角数字の形式で入力してください。'])
MESSAGE.append([109, 'W0109', '形式', '', ''])
MESSAGE.append([110, 'W0110', '形式', '異常気象コードに無効な文字が入力されています。', '全角文字:半角数字の形式で入力してください。'])
MESSAGE.append([111, 'W0111', '形式', '水害発生開始月に無効な文字が入力されています。', '半角数字の形式で入力してください。'])
MESSAGE.append([112, 'W0112', '形式', '水害発生開始日に無効な文字が入力されています。', '半角数字の形式で入力してください。'])
MESSAGE.append([113, 'W0113', '形式', '水害発生終了月に無効な文字が入力されています。', '半角数字の形式で入力してください。'])
MESSAGE.append([114, 'W0114', '形式', '水害発生終了日に無効な文字が入力されています。', '半角数字の形式で入力してください。'])
MESSAGE.append([115, 'W0115', '形式', '工種区分に無効な文字が入力されています。', '全角文字:半角数字の形式で入力してください。'])
MESSAGE.append([116, 'W0116', '形式', '', ''])
MESSAGE.append([117, 'W0117', '形式', '市区町村コードに無効な文字が入力されています。', '全角文字:半角数字の形式で入力してください。'])
MESSAGE.append([118, 'W0118', '形式', '災害復旧箇所に無効な文字が入力されています。', '半角数字の形式で入力してください。'])
MESSAGE.append([119, 'W0119', '形式', '災害復旧査定額(千円)に無効な文字が入力されています。', '半角数字の形式で入力してください。'])
MESSAGE.append([120, 'W0120', '形式', '備考に無効な文字が入力されています。', '全角文字の形式で入力してください。'])
...
### 範囲チェックのメッセージを定義する。
###############################################################################
MESSAGE.append([200, 'W0200', '範囲', 'NO.に範囲外の無効な値が入力されています。', ''])          ### 列1
MESSAGE.append([201, 'W0201', '範囲', '水系・沿岸名に範囲外の無効な値が入力されています。', '']) ### 列2
MESSAGE.append([202, 'W0202', '範囲', '水系種別に範囲外の無効な値が入力されています。', ''])     ### 列3
MESSAGE.append([203, 'W0203', '範囲', '河川・海岸名に範囲外の無効な値が入力されています。', ''])
MESSAGE.append([204, 'W0204', '範囲', '河川種別に範囲外の無効な値が入力されています。', ''])
MESSAGE.append([205, 'W0205', '範囲', '代表被災地区名に範囲外の無効な値が入力されています。', ''])
MESSAGE.append([206, 'W0206', '範囲', '都道府県名に範囲外の無効な値が入力されています。', ''])
MESSAGE.append([207, 'W0207', '範囲', '市区町村名に範囲外の無効な値が入力されています。', ''])
MESSAGE.append([208, 'W0208', '範囲', '都道府県コードに範囲外の無効な値が入力されています。', ''])
MESSAGE.append([209, 'W0209', '範囲', '', ''])
MESSAGE.append([210, 'W0210', '範囲', '異常気象コードに範囲外の無効な値が入力されています。', ''])
MESSAGE.append([211, 'W0211', '範囲', '水害発生開始月に範囲外の無効な値が入力されています。', '日付として有効な値を入力してください。'])
MESSAGE.append([212, 'W0212', '範囲', '水害発生開始日に範囲外の無効な値が入力されています。', '日付として有効な値を入力してください。'])
MESSAGE.append([213, 'W0213', '範囲', '水害発生終了月に範囲外の無効な値が入力されています。', '日付として有効な値を入力してください。'])
MESSAGE.append([214, 'W0214', '範囲', '水害発生終了日に範囲外の無効な値が入力されています。', '日付として有効な値を入力してください。'])
MESSAGE.append([215, 'W0215', '範囲', '工種区分に範囲外の無効な値が入力されています。', ''])
MESSAGE.append([216, 'W0216', '範囲', '', ''])
MESSAGE.append([217, 'W0217', '範囲', '市区町村コードに範囲外の無効な値が入力されています。', ''])
MESSAGE.append([218, 'W0218', '範囲', '災害復旧箇所に範囲外の無効な値が入力されています。', ''])
MESSAGE.append([219, 'W0219', '範囲', '災害復旧査定額(千円)に範囲外の無効な値が入力されています。', '正の値を入力してください。'])
MESSAGE.append([220, 'W0220', '範囲', '備考に範囲外の無効な値が入力されています。', ''])
