...
# -*- coding: utf-8 -*-
###############################################################################
### ファイル名：P0900Action/management/commands/action_A01_download_ippan_chosa.py
### A01：ダウンロード
###############################################################################
...
def create_ippan_chosa_workbook(suigai_count, suigai_id_list, suigai_name_list, ken_code, ken_name, city_code, city_name, 
    ...
    try:
        ...
        #######################################################################
        reset_log()
        print_log('[INFO] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数が開始しました。', 'INFO')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 suigai_count = {}'.format(suigai_count), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 suigai_id_list = {}'.format(suigai_id_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 suigai_name_list = {}'.format(suigai_name_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 ken_code = {}'.format(ken_code), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 ken_name = {}'.format(ken_name), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 city_code = {}'.format(city_code), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 city_name = {}'.format(city_name), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 VLOOK_VALUE = {}'.format(VLOOK_VALUE), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 building_list = {}'.format(building_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 ken_list = {}'.format(ken_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 kasen_kaigan_list = {}'.format(kasen_kaigan_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 suikei_list = {}'.format(suikei_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 suikei_type_list = {}'.format(suikei_type_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 kasen_type_list = {}'.format(kasen_type_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 cause_list = {}'.format(cause_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 underground_list = {}'.format(underground_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 usage_list = {}'.format(usage_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 flood_sediment_list = {}'.format(flood_sediment_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 gradient_list = {}'.format(gradient_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 industry_list = {}'.format(industry_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 area_list = {}'.format(area_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 weather_list = {}'.format(weather_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 suigai_list = {}'.format(suigai_list), 'DEBUG')
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 1/10.', 'DEBUG')
        ...
        ### (2)ワークシートを局所変数にセットする。
        #######################################################################
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 2/10.', 'DEBUG')
        ...
        #######################################################################
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 3/10.', 'DEBUG')
        ...
        ### マスタ用のシートに値をセットする。
        #######################################################################
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 4/10.', 'DEBUG')
        ### 1000: 建物区分シート
        ...
        #######################################################################
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 5/10.', 'DEBUG')
        ### 1020: 市区町村VLOOKUP
        ...
        #######################################################################
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 6/10.', 'DEBUG')
        for i in range(suigai_count + 10 + 1):
        ...
        #######################################################################
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 7/10.', 'DEBUG')
        ...
        #######################################################################
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 8/10.', 'DEBUG')
        for i in range(suigai_count + 10 + 1):
            ### 1000: 建物区分
        ...
        #######################################################################
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 9/10.', 'DEBUG')
        ...
        for i in range(suigai_count + 10 + 1):
            ...
            ### EXCEL入出力処理(0090)
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 9_1/10.', 'DEBUG')
        ...
        for i in range(suigai_count):
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 9_2/10.', 'DEBUG')

            ###################################################################
            ### DBアクセス処理(0100)
            ### 入力データ_ヘッダ部分のデータを取得する。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 9_3/10.', 'DEBUG')
            ...
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 9_4/10.', 'DEBUG')
            ...
            ### ※ k ループの回数＝1
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 9_5/10.', 'DEBUG')
            ...
            ### ※ k ループの回数＝行数
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 9_6/10.', 'DEBUG')
            if local_ippan_list:
        ...
        ### 戻り値を戻す。
        #######################################################################
        print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数 STEP 10/10.', 'DEBUG')
        print_log('[INFO] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数が正常終了しました。', 'INFO')
        return wb
        
    except:
        print_log(sys.exc_info()[0], 'ERROR')
        print_log('[ERROR] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数でエラーが発生しました。', 'ERROR')
        print_log('[ERROR] P0900Action.action_A01_download_ippan_chosa.create_ippan_chosa_workbook()関数が異常終了しました。', 'ERROR')
        return wb
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            ###################################################################
            reset_log()
            print_log('[INFO] P0900Action.action_A01_download_ippan_chosa.handle()関数が開始しました。', 'INFO')
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 STEP 1/8.', 'DEBUG')
            ...
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 STEP 2/8.', 'DEBUG')
            ...
            if trigger_list is None:
                print_log('[INFO] P0900Action.action_A01_download_ippan_chosa.handle()関数が正常終了しました。', 'INFO')
                return 0
            ...
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 trigger_list[0].trigger_id = {}'.format(trigger_list[0].trigger_id), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 trigger_list[0].suigai_id = {}'.format(trigger_list[0].suigai_id), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 trigger_list[0].city_code = {}'.format(trigger_list[0].city_code), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 trigger_list[0].ken_code = {}'.format(trigger_list[0].ken_code), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 trigger_list[0].download_file_path = {}'.format(trigger_list[0].download_file_path), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 trigger_list[0].download_file_name = {}'.format(trigger_list[0].download_file_name), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 trigger_list[0].upload_file_path = {}'.format(trigger_list[0].upload_file_path), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 trigger_list[0].upload_file_name = {}'.format(trigger_list[0].upload_file_name), 'DEBUG')
            ...
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 STEP 3/8.', 'DEBUG')
            ...
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 suigai_count_request = {}'.format(suigai_count_request), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 suigai_id_request = {}'.format(suigai_id_request), 'DEBUG')
    
            ###################################################################
            ### DBアクセス処理(0030)
            ### 市区町村コードを検索キーに、都道府県コード、都道府県名、市区町村名を取得する。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 STEP 4/8.', 'DEBUG')
            ...
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 ken_code_request = {}'.format(ken_code_request), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 ken_name_request = {}'.format(ken_name_request), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 city_code_request = {}'.format(city_code_request), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 city_name_request = {}'.format(city_name_request), 'DEBUG')
    
            ###################################################################
            ### DBアクセス処理(0040)
            ### マスタデータを取得する。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 STEP 5/8.', 'DEBUG')
            ### 1000: 建物区分シート
            ### 1010: 都道府県シート
            ...
            ### EXCEL入出力処理(0050)
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 STEP 6/8.', 'DEBUG')
            template_file_path = 'static/template_ippan_chosa.xlsx'
            ...
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 download_file_path = {}'.format(download_file_path), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 download_file_name = {}'.format(download_file_name), 'DEBUG')
            ...
            ### トリガーデータを更新する。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 STEP 7/8.', 'DEBUG')
            ...
            try:
                ...
                print_log('[ERROR] P0900Action.action_A01_download_ippan_chosa.handle()関数 {}'.format(sys.exc_info()[0]), 'ERROR')
            ...
            ### 戻り値を戻す。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A01_download_ippan_chosa.handle()関数 STEP 8/8.', 'DEBUG')
            print_log('[INFO] P0900Action.action_A01_download_ippan_chosa.handle()関数が正常終了しました。', 'INFO')
            return 0
        except:
            print_log('[ERROR] P0900Action.action_A01_download_ippan_chosa.handle()関数 {}'.format(sys.exc_info()[0]), 'ERROR')
            print_log('[ERROR] P0900Action.action_A01_download_ippan_chosa.handle()関数でエラーが発生しました。', 'ERROR')
            print_log('[ERROR] P0900Action.action_A01_download_ippan_chosa.handle()関数が異常終了しました。', 'ERROR')
            return 8
