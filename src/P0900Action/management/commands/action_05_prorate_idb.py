...
# -*- coding: utf-8 -*-
###############################################################################
### ファイル名：P0900Action/management/commands/action_05_prorate_idb.py
###############################################################################
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            ###################################################################
            print_log('[INFO] ########################################', 'INFO')
            print_log('[INFO] P0900Action.action_05_prorate_idb.handle()関数が開始しました。', 'INFO')
            print_log('[INFO] P0900Action.action_05_prorate_idb.handle()関数 STEP 1/5.', 'INFO')

            ###################################################################
            ### DBアクセス処理(0010)
            ###################################################################
            print_log('[INFO] P0900Action.action_05_prorate_idb.handle()関数 STEP 2/5.', 'INFO')
            ...
            if trigger_list is None:
                print_log('[INFO] P0900Action.action_05_prorate_idb.handle()関数が正常終了しました。', 'INFO')
                return 0
            ...
            ################################################################### 
            print_log('[INFO] P0900Action.action_05_prorate_idb.handle()関数 STEP 3/5.', 'INFO')
            ...
            ### 次のトリガーを発行する。
            ################################################################### 
            print_log('[INFO] P0900Action.action_05_prorate_idb.handle()関数 STEP 4/5.', 'INFO')
            connection_cursor.execute("""
                INSERT INTO TRIGGER (
            ...
            ### 戻り値セット処理(0040)
            ###################################################################
            print_log('[INFO] P0900Action.action_05_prorate_idb.handle()関数 STEP 5/5.', 'INFO')
            print_log('[INFO] P0900Action.action_05_prorate_idb.handle()関数が正常終了しました。', 'INFO')
            return 0
        
        except:
            print_log(sys.exc_info()[0], 'ERROR')
            print_log('[ERROR] P0900Action.action_05_prorate_idb.handle()関数でエラーが発生しました。', 'ERROR')
            print_log('[ERROR] P0900Action.action_05_prorate_idb.handle()関数が異常終了しました。', 'ERROR')
            return 8
