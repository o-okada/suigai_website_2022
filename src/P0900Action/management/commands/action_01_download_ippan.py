...
# -*- coding: utf-8 -*-
###############################################################################
### ファイル名：P0900Action/management/commands/action_01_download_ippan.py
###############################################################################
...
def create_ippan_chosa_workbook(suigai_count, suigai_id_list, suigai_name_list, ken_code, ken_name, city_code, city_name, 
    ...
    try:
        ...
        #######################################################################
        print_log('[INFO] ########################################', 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数が開始しました。', 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 suigai_count = {}'.format(suigai_count), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 suigai_id_list = {}'.format(suigai_id_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 suigai_name_list = {}'.format(suigai_name_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 ken_code = {}'.format(ken_code), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 ken_name = {}'.format(ken_name), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 city_code = {}'.format(city_code), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 city_name = {}'.format(city_name), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 VLOOK_VALUE = {}'.format(VLOOK_VALUE), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 building_list = {}'.format(building_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 ken_list = {}'.format(ken_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 kasen_kaigan_list = {}'.format(kasen_kaigan_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 suikei_list = {}'.format(suikei_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 suikei_type_list = {}'.format(suikei_type_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 kasen_type_list = {}'.format(kasen_type_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 cause_list = {}'.format(cause_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 underground_list = {}'.format(underground_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 usage_list = {}'.format(usage_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 flood_sediment_list = {}'.format(flood_sediment_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 gradient_list = {}'.format(gradient_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 industry_list = {}'.format(industry_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 area_list = {}'.format(area_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 weather_list = {}'.format(weather_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 suigai_list = {}'.format(suigai_list), 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 STEP 1/10.', 'INFO')
        ...
        #######################################################################
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 STEP 3/10.', 'INFO')
        ...
        ### マスタ用のシートに値をセットする。
        #######################################################################
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 STEP 4/10.', 'INFO')
        ### 1000: 建物区分シート
        ...
        #######################################################################
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 STEP 5/10.', 'INFO')
        ### 1020: 市区町村VLOOKUP
        ...
        #######################################################################
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 STEP 6/10.', 'INFO')
        for i in range(suigai_count + 10 + 1):
        ...
        #######################################################################
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 STEP 7/10.', 'INFO')
        ...
        #######################################################################
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 STEP 8/10.', 'INFO')
        for i in range(suigai_count + 10 + 1):
            ### 1000: 建物区分
        ...
        #######################################################################
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 STEP 9/10.', 'INFO')
        ...
        for i in range(suigai_count + 10 + 1):
            ...
            ### EXCEL入出力処理(0090)
            ###################################################################
            print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 STEP 9_1/10.', 'INFO')
        ...
        for i in range(suigai_count):
            print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 STEP 9_2/10.', 'INFO')

            ###################################################################
            ### DBアクセス処理(0100)
            ### 入力データ_ヘッダ部分のデータを取得する。
            ###################################################################
            print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 STEP 9_3/10.', 'INFO')
            local_suigai_list = SUIGAI.objects.raw("""
                ...
                WHERE 
                    SG1.suigai_id = %s LIMIT 1""", [suigai_id_list[i], ])
    
            ###################################################################
            ### DBアクセス処理(0110)
            ### 入力データ_一覧表部分のデータを取得する。
            ###################################################################
            print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 STEP 9_4/10.', 'INFO')
            local_ippan_list = IPPAN.objects.raw("""
                ...
                WHERE 
                    IV1.suigai_id = %s
                ORDER BY CAST (IV1.ippan_id AS INTEGER)""", [suigai_id_list[i], ])
            ...
            ### ※ k ループの回数＝1
            ###################################################################
            print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 STEP 9_5/10.', 'INFO')
            ...
            ### ※ k ループの回数＝行数
            ###################################################################
            print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 STEP 9_6/10.', 'INFO')
            if local_ippan_list:
        ...
        ### 戻り値を戻す。
        #######################################################################
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数 STEP 10/10.', 'INFO')
        print_log('[INFO] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数が正常終了しました。', 'INFO')
        return wb
        
    except:
        print_log(sys.exc_info()[0], 'ERROR')
        print_log('[ERROR] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数でエラーが発生しました。', 'ERROR')
        print_log('[ERROR] P0900Action.action_01_download_ippan.create_ippan_chosa_workbook()関数が異常終了しました。', 'ERROR')
        return wb
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            ### DBアクセス処理(0010)
            ###################################################################
            print_log('[INFO] P0900Action.action_01_download_ippan.handle()関数 STEP 2/8.', 'INFO')
            ...
            ###################################################################
            print_log('[INFO] P0900Action.action_01_download_ippan.handle()関数 STEP 3/8.', 'INFO')
            ...
            ###################################################################
            print_log('[INFO] P0900Action.action_01_download_ippan.handle()関数 STEP 4/8.', 'INFO')
            ...
            print_log('[INFO] P0900Action.action_01_download_ippan.handle()関数 ken_code_request = {}'.format(ken_code_request), 'INFO')
            print_log('[INFO] P0900Action.action_01_download_ippan.handle()関数 ken_name_request = {}'.format(ken_name_request), 'INFO')
            print_log('[INFO] P0900Action.action_01_download_ippan.handle()関数 city_code_request = {}'.format(city_code_request), 'INFO')
            print_log('[INFO] P0900Action.action_01_download_ippan.handle()関数 city_name_request = {}'.format(city_name_request), 'INFO')
    
            ###################################################################
            ### DBアクセス処理(0040)
            ### マスタデータを取得する。
            ###################################################################
            print_log('[INFO] P0900Action.action_01_download_ippan.handle()関数 STEP 5/8.', 'INFO')
            ### 1000: 建物区分シート
            ### 1010: 都道府県シート
            ...
            ### EXCEL入出力処理(0050)
            ###################################################################
            print_log('[INFO] P0900Action.action_01_download_ippan.handle()関数 STEP 6/8.', 'INFO')
            template_file_path = 'static/template_ippan_chosa.xlsx'
            ...
            ### トリガーデータを更新する。
            ###################################################################
            print_log('[INFO] P0900Action.action_01_download_ippan.handle()関数 STEP 7/8.', 'INFO')
            connection_cursor = connection.cursor()
            try:
            ...
            ### 戻り値を戻す。
            ###################################################################
            print_log('[INFO] P0900Action.action_01_download_ippan.handle()関数 STEP 8/8.', 'INFO')
            return 0
        
        except:
            print_log(sys.exc_info()[0], 'ERROR')
            print_log('[ERROR] P0900Action.action_01_download_ippan.handle()関数でエラーが発生しました。', 'ERROR')
            print_log('[ERROR] P0900Action.action_01_download_ippan.handle()関数が異常終了しました。', 'ERROR')
            return 8
