...
# -*- coding: utf-8 -*-
###############################################################################
### ファイル名：P0900Action/management/commands/action_A03_verify_idb_by_diff_method.py
### A04：差分検証
###############################################################################
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            ###################################################################
            reset_log()
            print_log('[INFO] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数が開始しました。', 'INFO')
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 STEP 1/12.', 'DEBUG')
            ...
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 STEP 2/12.', 'DEBUG')
            ...
            if trigger_list is None:
                print_log('[INFO] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数が正常終了しました。', 'INFO')
                return 0
            ...
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 trigger_list[0].trigger_id = {}'.format(trigger_list[0].trigger_id), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 trigger_list[0].suigai_id = {}'.format(trigger_list[0].suigai_id), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 trigger_list[0].city_code = {}'.format(trigger_list[0].city_code), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 trigger_list[0].ken_code = {}'.format(trigger_list[0].ken_code), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 trigger_list[0].download_file_path = {}'.format(trigger_list[0].download_file_path), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 trigger_list[0].download_file_name = {}'.format(trigger_list[0].download_file_name), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 trigger_list[0].upload_file_path = {}'.format(trigger_list[0].upload_file_path), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 trigger_list[0].upload_file_name = {}'.format(trigger_list[0].upload_file_name), 'DEBUG')

            ###################################################################
            ### DBアクセス処理(0020)
            ### DBから入力データ_ヘッダ部分のデータを取得する。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 STEP 3/12.', 'DEBUG')
            ...
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 STEP 4/12.', 'DEBUG')
            ...
            ### EXCELファイル入出力処理(0040)
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 STEP 5/12.', 'DEBUG')
            ...
            ###############################################################
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 STEP 6/12.', 'DEBUG')
            if suigai_list:
            ...
            ###############################################################
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 STEP 7/12.', 'DEBUG')
            if ippan_list:
            ...
            ### EXCELファイル入出力処理(0070)
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 STEP 8/12.', 'DEBUG')
            ws_input = None
            ...
            if ws_input is None:
                print_log('[ERROR] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 ws_input is None', 'ERROR')
                print_log('[ERROR] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数でエラーが発生しました。', 'ERROR')
                print_log('[ERROR] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数が異常終了しました。', 'ERROR')
                return 8
            ...
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 ws_max_row_input = {}'.format(ws_max_row_input), 'DEBUG')
            ...
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 ws_max_row_output = {}'.format(ws_max_row_output), 'DEBUG')
            ...
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 ws_max_row = {}'.format(ws_max_row), 'DEBUG')

            if ws_max_row < 20:
                print_log('[ERROR] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 ws_max_row = {}'.format(ws_max_row), 'ERROR')
                print_log('[ERROR] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数でエラーが発生しました。', 'ERROR')
                print_log('[ERROR] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数が異常終了しました。', 'ERROR')
                return 8
            ...
            ### 検証の心臓部
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 STEP 9/12.', 'DEBUG')
            success_count = 0
            failure_count = 0
            
            ### 7行目
            for i in [2, 3, 4, 5, 6, 7, 8, 9]:
                print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 ws_input.cell.value = {}'.format(ws_input.cell(row=7, column=i).value), 'DEBUG')
                print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 ws_output.cell.value = {}'.format(ws_output.cell(row=7, column=i).value), 'DEBUG')
            ...
            ### 10行目
            for i in [2, 3, 4, 5, 6]:
                print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 ws_input.cell.value = {}'.format(ws_input.cell(row=10, column=i).value), 'DEBUG')
                print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 ws_output.cell.value = {}'.format(ws_output.cell(row=10, column=i).value), 'DEBUG')
            ...
            ### 14行目
            for i in [2, 3, 4, 8]:
                print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 ws_input.cell.value = {}'.format(ws_input.cell(row=14, column=i).value), 'DEBUG')
                print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 ws_output.cell.value = {}'.format(ws_output.cell(row=14, column=i).value), 'DEBUG')
            ...
            for j in range(20, ws_max_row + 1):
                for k in range(1, 6):
                    print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 ws_input.cell.value = {}'.format(ws_input.cell(row=j, column=k).value), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 ws_output.cell.value = {}'.format(ws_output.cell(row=j, column=k).value), 'DEBUG')
            ...
            ################################################################### 
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 STEP 10/12.', 'DEBUG')
            ### 成功
            if failure_count == 0:
            ...
            try:
                ...
                ############################################################### 
                print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 STEP 11/12.', 'DEBUG')
                ### 成功 -> 次のトリガー
                if failure_count == 0:
                    connection_cursor.execute("""
                        INSERT INTO TRIGGER (
                ...
                print_log('[ERROR] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 {}'.format(sys.exc_info()[0]), 'ERROR')
            ...
            ### 戻り値を戻す。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 STEP 12/12.', 'DEBUG')
            print_log('[INFO] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数が正常終了しました。', 'INFO')
            return 0
        except:
            print_log('[ERROR] P0900Action.action_A03_verify_idb_by_diff_method.handle()関数 {}'.format(sys.exc_info()[0]), 'ERROR')
