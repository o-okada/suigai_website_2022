...
# -*- coding: utf-8 -*-
###############################################################################
### ファイル名：P0900Action/management/commands/action_A06_verify_idb_by_reverse_method.py
### A06：データ検証
###############################################################################
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            ###################################################################
            reset_log()
            print_log('[INFO] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数が開始しました。', 'INFO')
            print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 STEP 1/7.', 'DEBUG')
            ...
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 STEP 2/7.', 'DEBUG')
            ...
            if trigger_list is None:
                print_log('[INFO] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数が正常終了しました。', 'INFO')
                return 0
            ...
            print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 trigger_list[0].trigger_id = {}'.format(trigger_list[0].trigger_id), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 trigger_list[0].suigai_id = {}'.format(trigger_list[0].suigai_id), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 trigger_list[0].city_code = {}'.format(trigger_list[0].city_code), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 trigger_list[0].ken_code = {}'.format(trigger_list[0].ken_code), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 trigger_list[0].download_file_path = {}'.format(trigger_list[0].download_file_path), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 trigger_list[0].download_file_name = {}'.format(trigger_list[0].download_file_name), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 trigger_list[0].upload_file_path = {}'.format(trigger_list[0].upload_file_path), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 trigger_list[0].upload_file_name = {}'.format(trigger_list[0].upload_file_name), 'DEBUG')
            ...
            ### ※ネストを浅くするために、処理対象外の場合、処理を終了させる。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 STEP 3/7.', 'DEBUG')
            ...
            if ippan_reverse_list is None:
                print_log('[WARN] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数が警告終了しました。', 'WARN')
                return 4
            ...
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 STEP 4/7.', 'DEBUG')
            success_count = 0
            failure_count = 0
            ### epsilon = 0.0000001
            ...
            for ippan in ippan_reverse_list:
                ...
                ### 被害建物の延床面積(入力DB)から逆計算により被害建物棟数を求めた結果
                ###############################################################
                print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 STEP 4_1/7.', 'DEBUG')
                if ippan.building_lv00_reverse_floor_area is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv00_reverse_floor_area = {}'.format(ippan.building_lv00_reverse_floor_area), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv00 = {}'.format(ippan.building_lv00), 'DEBUG')
                ...
                if ippan.building_lv01_49_reverse_floor_area is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv01_49_reverse_floor_area = {}'.format(ippan.building_lv01_49_reverse_floor_area), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv01_49 = {}'.format(ippan.building_lv01_49), 'DEBUG')
                ...
                if ippan.building_lv50_99_reverse_floor_area is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv50_99_reverse_floor_area = {}'.format(ippan.building_lv50_99_reverse_floor_area), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv50_99 = {}'.format(ippan.building_lv50_99), 'DEBUG')
                ...
                if ippan.building_lv100_reverse_floor_area is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv100_reverse_floor_area = {}'.format(ippan.building_lv100_reverse_floor_area), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv100 = {}'.format(ippan.building_lv100), 'DEBUG')
                ...
                if ippan.building_half_reverse_floor_area is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_half_reverse_floor_area = {}'.format(ippan.building_half_reverse_floor_area), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_half = {}'.format(ippan.building_half), 'DEBUG')
                ...
                if ippan.building_full_reverse_floor_area is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_full_reverse_floor_area = {}'.format(ippan.building_full_reverse_floor_area), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_full = {}'.format(ippan.building_full), 'DEBUG')
                ...
                ### 被災世帯数(入力DB)から逆計算により被害建物棟数を求めた結果
                ###############################################################
                print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 STEP 4_2/7.', 'DEBUG')
                if ippan.building_lv00_reverse_family is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv00_reverse_family = {}'.format(ippan.building_lv00_reverse_family), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv00 = {}'.format(ippan.building_lv00), 'DEBUG')
                ...
                if ippan.building_lv01_49_reverse_family is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv01_49_reverse_family = {}'.format(ippan.building_lv01_49_reverse_family), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv01_49 = {}'.format(ippan.building_lv01_49), 'DEBUG')
                ...
                if ippan.building_lv50_99_reverse_family is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv50_99_reverse_family = {}'.format(ippan.building_lv50_99_reverse_family), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv50_99 = {}'.format(ippan.building_lv50_99), 'DEBUG')
                ...
                if ippan.building_lv100_reverse_family is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv100_reverse_family = {}'.format(ippan.building_lv100_reverse_family), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv100 = {}'.format(ippan.building_lv100), 'DEBUG')
                ...
                if ippan.building_half_reverse_family is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_half_reverse_family = {}'.format(ippan.building_half_reverse_family), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_half = {}'.format(ippan.building_half), 'DEBUG')
                ...
                if ippan.building_full_reverse_family is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_full_reverse_family = {}'.format(ippan.building_full_reverse_family), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_full = {}'.format(ippan.building_full), 'DEBUG')
                ...
                ### 被災事業所数(入力DB)から逆計算により被害建物棟数を求めた結果
                ###############################################################
                print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 STEP 4_3/7.', 'DEBUG')
                if ippan.building_lv00_reverse_office is not None: 
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv00_reverse_office = {}'.format(ippan.building_lv00_reverse_office), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv00 = {}'.format(ippan.building_lv00), 'DEBUG')
                ...
                if ippan.building_lv01_49_reverse_office is not None: 
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv01_49_reverse_office = {}'.format(ippan.building_lv01_49_reverse_office), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv01_49 = {}'.format(ippan.building_lv01_49), 'DEBUG')
                ...
                if ippan.building_lv50_99_reverse_office is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv50_99_reverse_office = {}'.format(ippan.building_lv50_99_reverse_office), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv50_99 = {}'.format(ippan.building_lv50_99), 'DEBUG')
                ...
                if ippan.building_lv100_reverse_office is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv100_reverse_office = {}'.format(ippan.building_lv100_reverse_office), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_lv100 = {}'.format(ippan.building_lv100), 'DEBUG')
                ...
                if ippan.building_half_reverse_office is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_half_reverse_office = {}'.format(ippan.building_half_reverse_office), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_half = {}'.format(ippan.building_half), 'DEBUG')
                ...
                if ippan.building_full_reverse_office is not None:
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_full_reverse_office = {}'.format(ippan.building_full_reverse_office), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 building_full = {}'.format(ippan.building_full), 'DEBUG')
            ...
            ################################################################### 
            print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 STEP 5/7.', 'DEBUG')
            ...
            try:
                ...
                ###############################################################
                print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 STEP 6/7.', 'DEBUG')
                ### 成功
                if failure_count == 0:
                    connection_cursor.execute("""
                        INSERT INTO TRIGGER (
                ...
                print_log('[ERROR] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 {}'.format(sys.exc_info()[0]), 'ERROR')
            ...
            ### 戻り値を戻す。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 STEP 7/7.', 'DEBUG')
            print_log('[INFO] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数が正常終了しました。', 'INFO')
            return 0
        except:
            print_log('[ERROR] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数 {}'.format(sys.exc_info()[0]), 'ERROR')
            print_log('[ERROR] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数でエラーが発生しました。', 'ERROR')
            print_log('[ERROR] P0900Action.action_A06_verify_idb_by_reverse_method.handle()関数が異常終了しました。', 'ERROR')
            return 8
