...
# -*- coding: utf-8 -*-
###############################################################################
### ファイル名：P0900Action/management/commands/action_A07_verify_sdb_by_reverse_method.py
### A08：データ検証
###############################################################################
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            ###################################################################
            reset_log()
            print_log('[INFO] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数が開始しました。', 'INFO')
            print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 1/8.', 'DEBUG')
            ...
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 2/8.', 'DEBUG')
            ...
            if trigger_list is None:
                print_log('[INFO] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数が正常終了しました。', 'INFO')
                return 0
            ...
            print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 trigger_list[0].trigger_id = {}'.format(trigger_list[0].trigger_id), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 trigger_list[0].suigai_id = {}'.format(trigger_list[0].suigai_id), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 trigger_list[0].city_code = {}'.format(trigger_list[0].city_code), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 trigger_list[0].ken_code = {}'.format(trigger_list[0].ken_code), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 trigger_list[0].download_file_path = {}'.format(trigger_list[0].download_file_path), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 trigger_list[0].download_file_name = {}'.format(trigger_list[0].download_file_name), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 trigger_list[0].upload_file_path = {}'.format(trigger_list[0].upload_file_path), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 trigger_list[0].upload_file_name = {}'.format(trigger_list[0].upload_file_name), 'DEBUG')
            
            ###################################################################
            ### DBアクセス処理(0020)
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 3/8.', 'DEBUG')
            ...
            if ippan_reverse_list is None:
                print_log('[WARN] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数が警告終了しました。', 'WARN')
                return 4
            ...
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 4/8.', 'DEBUG')
            success_count = 0
            failure_count = 0
            ### epsilon = 0.0000001
            ...
            for ippan in ippan_reverse_list:
                ...
                ### 家屋被害額(集計DB)から逆計算により延床面積を求めた結果 
                ###############################################################
                print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 4_1/8.', 'DEBUG')
                if ippan.floor_area_lv00_reverse_house_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 floor_area_lv00_reverse_house_summary = {}'.format(ippan.floor_area_lv00_reverse_house_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 floor_area_lv00 = {}'.format(ippan.floor_area_lv00), 'DEBUG')
                ...
                if ippan.floor_area_lv01_49_reverse_house_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 floor_area_lv01_49_reverse_house_summary = {}'.format(ippan.floor_area_lv01_49_reverse_house_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 floor_area_lv01_49 = {}'.format(ippan.floor_area_lv01_49), 'DEBUG')
                ...
                if ippan.floor_area_lv50_99_reverse_house_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 floor_area_lv50_99_reverse_house_summary = {}'.format(ippan.floor_area_lv50_99_reverse_house_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 floor_area_lv50_99 = {}'.format(ippan.floor_area_lv50_99), 'DEBUG')
                ...
                if ippan.floor_area_lv100_reverse_house_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 floor_area_lv100_reverse_house_summary = {}'.format(ippan.floor_area_lv100_reverse_house_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 floor_area_lv100 = {}'.format(ippan.floor_area_lv100), 'DEBUG')
                ...
                if ippan.floor_area_half_reverse_house_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 floor_area_half_reverse_house_summary = {}'.format(ippan.floor_area_half_reverse_house_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 floor_area_half = {}'.format(ippan.floor_area_half), 'DEBUG')
                ...
                if ippan.floor_area_full_reverse_house_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 floor_area_full_reverse_house_summary = {}'.format(ippan.floor_area_full_reverse_house_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 floor_area_full = {}'.format(ippan.floor_area_full), 'DEBUG')
                ...
                ### 家庭用品自動車以外被害額(集計DB)から逆計算により被災世帯数を求めた結果 
                ###############################################################
                print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 4_2/8.', 'DEBUG')
                if ippan.family_lv00_reverse_household_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv00_reverse_household_summary = {}'.format(ippan.family_lv00_reverse_household_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv00 = {}'.format(ippan.family_lv00), 'DEBUG')
                ...
                if ippan.family_lv01_49_reverse_household_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv01_49_reverse_household_summary = {}'.format(ippan.family_lv01_49_reverse_household_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv01_49 = {}'.format(ippan.family_lv01_49), 'DEBUG')
                ...
                if ippan.family_lv50_99_reverse_household_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv50_99_reverse_household_summary = {}'.format(ippan.family_lv50_99_reverse_household_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv50_99 = {}'.format(ippan.family_lv50_99), 'DEBUG')
                ...
                if ippan.family_lv100_reverse_household_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv100_reverse_household_summary = {}'.format(ippan.family_lv100_reverse_household_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 famly_lv100 = {}'.format(ippan.family_lv100), 'DEBUG')
                ...
                if ippan.family_half_reverse_household_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_half_reverse_household_summary = {}'.format(ippan.family_half_reverse_household_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_half = {}'.format(ippan.family_half), 'DEBUG')
                ...
                if ippan.family_full_reverse_household_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_full_reverse_household_summary = {}'.format(ippan.family_full_reverse_household_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_full = {}'.format(ippan.family_full), 'DEBUG')
                ...
                ### 家庭用品自動車被害額(集計DB)から逆計算により被災世帯数を求めた結果 
                ###############################################################
                print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 4_3/8.', 'DEBUG')
                if ippan.family_lv00_reverse_car_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv00_reverse_car_summary = {}'.format(ippan.family_lv00_reverse_car_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv00 = {}'.format(ippan.family_lv00), 'DEBUG')
                ...
                if ippan.family_lv01_49_reverse_car_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv01_49_reverse_car_summary = {}'.format(ippan.family_lv01_49_reverse_car_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv01_49 = {}'.format(ippan.family_lv01_49), 'DEBUG')
                ...
                if ippan.family_lv50_99_reverse_car_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv50_99_reverse_car_summary = {}'.format(ippan.family_lv50_99_reverse_car_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv50_99 = {}'.format(ippan.family_lv50_99), 'DEBUG')
                ...
                if ippan.family_lv100_reverse_car_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv100_reverse_car_summary = {}'.format(ippan.family_lv100_reverse_car_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv100 = {}'.format(ippan.family_lv100), 'DEBUG')
                ...
                if ippan.family_half_reverse_car_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_half_reverse_car_summary = {}'.format(ippan.family_half_reverse_car_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_half = {}'.format(ippan.family_half), 'DEBUG')
                ...
                if ippan.family_full_reverse_car_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_full_reverse_car_summary = {}'.format(ippan.family_full_reverse_car_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_full = {}'.format(ippan.family_full), 'DEBUG')
                ...
                ### 家庭応急対策費_代替活動費(集計DB)から逆計算により被災世帯数を求めた結果 
                ############################################################### 
                print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 4_4/8.', 'DEBUG')
                if ippan.family_lv00_reverse_house_alt_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv00_reverse_house_alt_summary = {}'.format(ippan.family_lv00_reverse_house_alt_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv00 = {}'.format(ippan.family_lv00), 'DEBUG')
                ...
                if ippan.family_lv01_49_reverse_house_alt_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv01_49_reverse_house_alt_summary = {}'.format(ippan.family_lv01_49_reverse_house_alt_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv01_49 = {}'.format(ippan.family_lv01_49), 'DEBUG')
                ...
                if ippan.family_lv50_99_reverse_house_alt_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv50_99_reverse_house_alt_summary = {}'.format(ippan.family_lv50_99_reverse_house_alt_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv50_99 = {}'.format(ippan.family_lv50_99), 'DEBUG')
                ...
                if ippan.family_lv100_reverse_house_alt_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv100_reverse_house_alt_summary = {}'.format(ippan.family_lv100_reverse_house_alt_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv100 = {}'.format(ippan.family_lv100), 'DEBUG')
                ...
                if ippan.family_half_reverse_house_alt_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_half_reverse_house_alt_summary = {}'.format(ippan.family_half_reverse_house_alt_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_half = {}'.format(ippan.family_half), 'DEBUG')
                ...
                if ippan.family_full_reverse_house_alt_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_full_reverse_house_alt_summary = {}'.format(ippan.family_full_reverse_house_alt_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_full = {}'.format(ippan.family_full), 'DEBUG')
                ...
                ### 家庭応急対策費_清掃費(集計DB)から逆計算により被災世帯数を求めた結果 
                ############################################################### 
                print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 4_5/8.', 'DEBUG')
                if ippan.family_lv00_reverse_house_clean_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv00_reverse_house_clean_summary = {}'.format(ippan.family_lv00_reverse_house_clean_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv00 = {}'.format(ippan.family_lv00), 'DEBUG')
                ...
                if ippan.family_lv01_49_reverse_house_clean_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv01_49_reverse_house_clean_summary = {}'.format(ippan.family_lv01_49_reverse_house_clean_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv01_49 = {}'.format(ippan.family_lv01_49), 'DEBUG')
                ...
                if ippan.family_lv50_99_reverse_house_clean_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv50_99_reverse_house_clean_summary = {}'.format(ippan.family_lv50_99_reverse_house_clean_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv50_99 = {}'.format(ippan.family_lv50_99), 'DEBUG')
                ...
                if ippan.family_lv100_reverse_house_clean_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv100_reverse_house_clean_summary = {}'.format(ippan.family_lv100_reverse_house_clean_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_lv100 = {}'.format(ippan.family_lv100), 'DEBUG')
                ...
                if ippan.family_half_reverse_house_clean_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_half_reverse_house_clean_summary = {}'.format(ippan.family_half_reverse_house_clean_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_half = {}'.format(ippan.family_half), 'DEBUG')
                ...
                if ippan.family_full_reverse_house_clean_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_full_reverse_house_clean_summary = {}'.format(ippan.family_full_reverse_house_clean_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 family_full = {}'.format(ippan.family_full), 'DEBUG')
                ...
                ### 事業所被害額_償却資産被害額(集計DB)から逆計算により被災従業者数を求めた結果 
                ############################################################### 
                print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 4_6/8.', 'DEBUG')
                if ippan.employee_lv00_reverse_office_dep_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv00_reverse_office_dep_summary = {}'.format(ippan.employee_lv00_reverse_office_dep_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv00 = {}'.format(ippan.employee_lv00), 'DEBUG')
                ...
                if ippan.employee_lv01_49_reverse_office_dep_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv01_49_reverse_office_dep_summary = {}'.format(ippan.employee_lv01_49_reverse_office_dep_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv01_49 = {}'.format(ippan.employee_lv01_49), 'DEBUG')
                ...
                if ippan.employee_lv50_99_reverse_office_dep_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv50_99_reverse_office_dep_summary = {}'.format(ippan.employee_lv50_99_reverse_office_dep_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv50_99 = {}'.format(ippan.employee_lv50_99), 'DEBUG')
                ...
                if ippan.employee_lv100_reverse_office_dep_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv100_reverse_office_dep_summary = {}'.format(ippan.employee_lv100_reverse_office_dep_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv100 = {}'.format(ippan.employee_lv100), 'DEBUG')
                ...
                ###     print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_half_reverse_office_dep_summary = {}'.format(ippan.employee_half_reverse_office_dep_summary), 'DEBUG')
                ###     print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_half = {}'.format(ippan.employee_half), 'DEBUG')
                ...
                if ippan.employee_full_reverse_office_dep_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_full_reverse_office_dep_summary = {}'.format(ippan.employee_full_reverse_office_dep_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_full = {}'.format(ippan.employee_full), 'DEBUG')
                ...
                ### 事業所被害額_在庫資産被害額(集計DB)から逆計算により被災従業者数を求めた結果 
                ############################################################### 
                print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 4_7/8.', 'DEBUG')
                if ippan.employee_lv00_reverse_office_inv_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv00_reverse_office_inv_summary = {}'.format(ippan.employee_lv00_reverse_office_inv_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv00 = {}'.format(ippan.employee_lv00), 'DEBUG')
                ...
                if ippan.employee_lv01_49_reverse_office_inv_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv01_49_reverse_office_inv_summary = {}'.format(ippan.employee_lv01_49_reverse_office_inv_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv01_49 = {}'.format(ippan.employee_lv01_49), 'DEBUG')
                ...
                if ippan.employee_lv50_99_reverse_office_inv_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv50_99_reverse_office_inv_summary = {}'.format(ippan.employee_lv50_99_reverse_office_inv_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv50_99 = {}'.format(ippan.employee_lv50_99), 'DEBUG')
                ...
                if ippan.employee_lv100_reverse_office_inv_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv100_reverse_office_inv_summary = {}'.format(ippan.employee_lv100_reverse_office_inv_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv100 = {}'.format(ippan.employee_lv100), 'DEBUG')
                ...
                ###     print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_half_reverse_office_inv_summary = {}'.format(ippan.employee_half_reverse_office_inv_summary), 'DEBUG')
                ###     print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_half = {}'.format(ippan.employee_half), 'DEBUG')
                ...
                if ippan.employee_full_reverse_office_inv_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_full_reverse_office_inv_summary = {}'.format(ippan.employee_full_reverse_office_inv_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_full = {}'.format(ippan.employee_full), 'DEBUG')
                ...
                ### 事業所被害額_営業停止に伴う被害額(集計DB)から逆計算により被災従業者数を求めた結果
                ############################################################### 
                print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 4_8/8.', 'DEBUG')
                if ippan.employee_lv00_reverse_office_sus_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv00_reverse_office_sus_summary = {}'.format(ippan.employee_lv00_reverse_office_sus_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv00 = {}'.format(ippan.employee_lv00), 'DEBUG')
                ...
                if ippan.employee_lv01_49_reverse_office_sus_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv01_49_reverse_office_sus_summary = {}'.format(ippan.employee_lv01_49_reverse_office_sus_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv01_49 = {}'.format(ippan.employee_lv01_49), 'DEBUG')
                ...
                if ippan.employee_lv50_99_reverse_office_sus_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv50_99_reverse_office_sus_summary = {}'.format(ippan.employee_lv50_99_reverse_office_sus_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv50_99 = {}'.format(ippan.employee_lv50_99), 'DEBUG')
                ...
                if ippan.employee_lv100_reverse_office_sus_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv100_reverse_office_sus_summary = {}'.format(ippan.employee_lv100_reverse_office_sus_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv100 = {}'.format(ippan.employee_lv100), 'DEBUG')
                ...
                ###     print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_half_reverse_office_sus_summary = {}'.format(ippan.employee_half_reverse_office_sus_summary), 'DEBUG')
                ###     print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_half = {}'.format(ippan.employee_half), 'DEBUG')
                ...
                if ippan.employee_full_reverse_office_sus_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_full_reverse_office_sus_summary = {}'.format(ippan.employee_full_reverse_office_sus_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_full = {}'.format(ippan.employee_full), 'DEBUG')
                ...
                ### 事業所被害額_営業停滞に伴う被害額(集計DB)から逆計算により被災従業者数を求めた結果
                ############################################################### 
                print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 4_9/8.', 'DEBUG')
                if ippan.employee_lv00_reverse_office_stg_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv00_reverse_office_stg_summary = {}'.format(ippan.employee_lv00_reverse_office_stg_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv00 = {}'.format(ippan.employee_lv00), 'DEBUG')
                ...
                if ippan.employee_lv01_49_reverse_office_stg_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv01_49_reverse_office_stg_summary = {}'.format(ippan.employee_lv01_49_reverse_office_stg_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv01_49 = {}'.format(ippan.employee_lv01_49), 'DEBUG')
                ...
                if ippan.employee_lv50_99_reverse_office_stg_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv50_99_reverse_office_stg_summary = {}'.format(ippan.employee_lv50_99_reverse_office_stg_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv50_99 = {}'.format(ippan.employee_lv50_99), 'DEBUG')
                ...
                if ippan.employee_lv100_reverse_office_stg_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv100_reverse_office_stg_summary = {}'.format(ippan.employee_lv100_reverse_office_stg_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_lv100 = {}'.format(ippan.employee_lv100), 'DEBUG')
                ...
                ###     print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_half_reverse_office_stg_summary = {}'.format(ippan.employee_half_reverse_office_stg_summary), 'DEBUG')
                ###     print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_half = {}'.format(ippan.employee_half), 'DEBUG')
                ...
                if ippan.employee_full_reverse_office_stg_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_full_reverse_office_stg_summary = {}'.format(ippan.employee_full_reverse_office_stg_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 employee_full = {}'.format(ippan.employee_full), 'DEBUG')
                ...
                ### 農漁家被害額_償却資産被害額(集計DB)から逆計算により農漁家戸数を求めた結果 
                ###############################################################
                print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 4_10/8.', 'DEBUG')
                if ippan.farmer_fisher_lv00_reverse_farmer_fisher_dep_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv00_reverse_farmer_fisher_dep_summary = {}'.format(ippan.farmer_fisher_lv00_reverse_farmer_fisher_dep_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv00 = {}'.format(ippan.farmer_fisher_lv00), 'DEBUG')
                ...
                if ippan.farmer_fisher_lv01_49_reverse_farmer_fisher_dep_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv01_49_reverse_farmer_fisher_dep_summary = {}'.format(ippan.farmer_fisher_lv01_49_reverse_farmer_fisher_dep_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv01_49 = {}'.format(ippan.farmer_fisher_lv01_49), 'DEBUG')
                ...
                if ippan.farmer_fisher_lv50_99_reverse_farmer_fisher_dep_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv50_99_reverse_farmer_fisher_dep_summary = {}'.format(ippan.farmer_fisher_lv50_99_reverse_farmer_fisher_dep_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv50_99 = {}'.format(ippan.farmer_fisher_lv50_99), 'DEBUG')
                ...
                if ippan.farmer_fisher_lv100_reverse_farmer_fisher_dep_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv100_reverse_farmer_fisher_dep_summary = {}'.format(ippan.farmer_fisher_lv100_reverse_farmer_fisher_dep_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv100 = {}'.format(ippan.farmer_fisher_lv100), 'DEBUG')
                ...
                ###     print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_half_reverse_farmer_fisher_dep_summary = {}'.format(ippan.farmer_fisher_half_reverse_farmer_fisher_dep_summary), 'DEBUG')
                ###     print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_half = {}'.format(ippan.farmer_fisher_half), 'DEBUG')
                ...
                if ippan.farmer_fisher_full_reverse_farmer_fisher_dep_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_full_reverse_farmer_fisher_dep_summary = {}'.format(ippan.farmer_fisher_full_reverse_farmer_fisher_dep_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_full = {}'.format(ippan.farmer_fisher_full), 'DEBUG')
                ...
                ### 農漁家被害額_在庫資産被害額(集計DB)から逆計算により農漁家戸数を求めた結果
                ############################################################### 
                print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 4_11/8.', 'DEBUG')
                if ippan.farmer_fisher_lv00_reverse_farmer_fisher_inv_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv00_reverse_farmer_fisher_inv_summary = {}'.format(ippan.farmer_fisher_lv00_reverse_farmer_fisher_inv_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv00 = {}'.format(ippan.farmer_fisher_lv00), 'DEBUG')
                ...
                if ippan.farmer_fisher_lv01_49_reverse_farmer_fisher_inv_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv01_49_reverse_farmer_fisher_inv_summary = {}'.format(ippan.farmer_fisher_lv01_49_reverse_farmer_fisher_inv_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv01_49 = {}'.format(ippan.farmer_fisher_lv01_49), 'DEBUG')
                ...
                if ippan.farmer_fisher_lv50_99_reverse_farmer_fisher_inv_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv50_99_reverse_farmer_fisher_inv_summary = {}'.format(ippan.farmer_fisher_lv50_99_reverse_farmer_fisher_inv_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv50_99 = {}'.format(ippan.farmer_fisher_lv50_99), 'DEBUG')
                ...
                if ippan.farmer_fisher_lv100_reverse_farmer_fisher_inv_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv100_reverse_farmer_fisher_inv_summary = {}'.format(ippan.farmer_fisher_lv100_reverse_farmer_fisher_inv_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_lv100 = {}'.format(ippan.farmer_fisher_lv100), 'DEBUG')
                ...
                ###     print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_half_reverse_farmer_fisher_inv_summary = {}'.format(ippan.farmer_fisher_half_reverse_farmer_fisher_inv_summary), 'DEBUG')
                ###     print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_half = {}'.format(ippan.farmer_fisher_half), 'DEBUG')
                ...
                if ippan.farmer_fisher_full_reverse_farmer_fisher_inv_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_full_reverse_farmer_fisher_inv_summary = {}'.format(ippan.farmer_fisher_full_reverse_farmer_fisher_inv_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 farmer_fisher_full = {}'.format(ippan.farmer_fisher_full), 'DEBUG')
                ...
                ### 事業所応急対策費_代替活動費(集計DB)から逆計算により被災事業所数を求めた結果 
                ############################################################### 
                print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 4_12/8.', 'DEBUG')
                if ippan.office_lv00_reverse_office_alt_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 office_lv00_reverse_office_alt_summary = {}'.format(ippan.office_lv00_reverse_office_alt_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 office_lv00 = {}'.format(ippan.office_lv00), 'DEBUG')
                ...
                if ippan.office_lv01_49_reverse_office_alt_summary is not None: 
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 office_lv01_49_reverse_office_alt_summary = {}'.format(ippan.office_lv01_49_reverse_office_alt_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 office_lv01_49 = {}'.format(ippan.office_lv01_49), 'DEBUG')
                ...
                if ippan.office_lv50_99_reverse_office_alt_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 office_lv50_99_reverse_office_alt_summary = {}'.format(ippan.office_lv50_99_reverse_office_alt_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 office_lv50_99 = {}'.format(ippan.office_lv50_99), 'DEBUG')
                ...
                if ippan.office_lv100_reverse_office_alt_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 office_lv100_reverse_office_alt_summary = {}'.format(ippan.office_lv100_reverse_office_alt_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 office_lv100 = {}'.format(ippan.office_lv100), 'DEBUG')
                ...
                ###     print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 office_half_reverse_office_alt_summary = {}'.format(ippan.office_half_reverse_office_alt_summary), 'DEBUG')
                ###     print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 office_half = {}'.format(ippan.office_half), 'DEBUG')
                ...
                if ippan.office_full_reverse_office_alt_summary is not None:
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 office_full_reverse_office_alt_summary = {}'.format(ippan.office_full_reverse_office_alt_summary), 'DEBUG')
                    print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 office_full = {}'.format(ippan.office_full), 'DEBUG')
            ...
            ################################################################### 
            print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 5/8.', 'DEBUG')
            ### 成功
            if failure_count == 0:
            ...
            try:
                ...
                ###############################################################
                ### print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 6/8.', 'DEBUG')
                ### ### 成功
                ### if failure_count == 0:
                ###     connection_cursor.execute("""
                ###         UPDATE SUIGAI SET 
                ...
                ### (2)失敗の場合は、次のトリガーを発行しない。
                ###############################################################
                print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 7/8.', 'DEBUG')
                ### 成功
                if failure_count == 0:
                    connection_cursor.execute("""
                        INSERT INTO TRIGGER (
                ...
                print_log('[ERROR] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 {}'.format(sys.exc_info()[0]), 'ERROR')
            ...
            ### 戻り値を戻す。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 STEP 8/8.', 'DEBUG')
            print_log('[INFO] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数が正常終了しました。', 'INFO')
            return 0
        except:
            print_log('[ERROR] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数 {}'.format(sys.exc_info()[0]), 'ERROR')
            print_log('[ERROR] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数でエラーが発生しました。', 'ERROR')
            print_log('[ERROR] P0900Action.action_A07_verify_sdb_by_reverse_method.handle()関数が異常終了しました。', 'ERROR')
            return 8
