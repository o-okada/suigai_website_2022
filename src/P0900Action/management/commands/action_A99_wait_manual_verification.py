...
# -*- coding: utf-8 -*-
###############################################################################
### ファイル名：P0900Action/management/commands/action_A99_manual_verification.py
### A99：マニュアル検証待ち
###############################################################################
    ...
    def handle(self, *args, **options):
        try:
            ...
            trigger_list = TRIGGER.objects.raw("""
                ...
                WHERE 
                    TR1.action_code='A99' AND 
                    TR1.consumed_at IS NULL AND 
                    TR1.deleted_at IS NULL 
                ORDER BY CAST(TR1.ken_code AS INTEGER), CAST(TR1.city_code AS INTEGER) LIMIT 1""", [])
            ...
            print_log('[DEBUG] P0900Action.action_A99_manual_verification.handle()関数 trigger_list[0].trigger_id = {}'.format(trigger_list[0].trigger_id), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A99_manual_verification.handle()関数 trigger_list[0].suigai_id = {}'.format(trigger_list[0].suigai_id), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A99_manual_verification.handle()関数 trigger_list[0].city_code = {}'.format(trigger_list[0].city_code), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A99_manual_verification.handle()関数 trigger_list[0].ken_code = {}'.format(trigger_list[0].ken_code), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A99_manual_verification.handle()関数 trigger_list[0].download_file_path = {}'.format(trigger_list[0].download_file_path), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A99_manual_verification.handle()関数 trigger_list[0].download_file_name = {}'.format(trigger_list[0].download_file_name), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A99_manual_verification.handle()関数 trigger_list[0].upload_file_path = {}'.format(trigger_list[0].upload_file_path), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A99_manual_verification.handle()関数 trigger_list[0].upload_file_name = {}'.format(trigger_list[0].upload_file_name), 'DEBUG')
            ...
            summary_file_path = 'static/ippan_summary_' + str(trigger_list[0].city_code) + '_' + str(trigger_list[0].ken_name) + '_' + str(trigger_list[0].city_name) + '.xlsx'
            summary_file_name = 'ippan_summary_' + str(trigger_list[0].city_code) + '_' + str(trigger_list[0].ken_name) + '_' + str(trigger_list[0].city_name) + '.xlsx'
            ### print_log('[DEBUG] P0900Action.action_A99_manual_verification.handle()関数 download_file_path = {}'.format(download_file_path), 'DEBUG')
            ### print_log('[DEBUG] P0900Action.action_A99_manual_verification.handle()関数 download_file_name = {}'.format(download_file_name), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A99_manual_verification.handle()関数 summary_file_path = {}'.format(summary_file_path), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_A99_manual_verification.handle()関数 summary_file_name = {}'.format(summary_file_name), 'DEBUG')
            ...
            ### ws_ippan.cell(row=6, column=14).value = '水系・沿岸名[全角]'
            ### ws_ippan.cell(row=6, column=15).value = '水系種別[全角]'
            ### ws_ippan.cell(row=6, column=16).value = '河川・海岸名[全角]'
            ### ws_ippan.cell(row=6, column=17).value = '河川種別[全角]'
            ### ws_ippan.cell(row=6, column=18).value = '地盤勾配区分'
            ### ws_ippan.cell(row=6, column=19).value = '町丁名・大字名[全角]'
            ### ws_ippan.cell(row=6, column=20).value = '名称[全角]'
            ...
            ### ws_ippan.cell(row=6, column=29).value = '被害建物の延床面積(m2)'
            ...
            ### ws_ippan.cell(row=6, column=44).value = ''
            ### ws_ippan.cell(row=6, column=45).value = ''
            ### ws_ippan.cell(row=6, column=46).value = ''
            ### ws_ippan.cell(row=6, column=47).value = ''
            ### ws_ippan.cell(row=6, column=44).value = '備考1'
            ### ws_ippan.cell(row=6, column=45).value = '備考2'
            ### ws_ippan.cell(row=6, column=46).value = '水害区域面積(宅地)(m2)'
            ### ws_ippan.cell(row=6, column=47).value = '水害区域面積(農地)(m2)'
            ### ws_ippan.cell(row=6, column=48).value = '水害区域面積(地下)(m2)'
            ...
            ### ws_ippan.cell(row=6, column=56).value = '家屋被害額_床下'
            ### ws_ippan.cell(row=6, column=57).value = '家屋被害額_01から49cm'
            ### ws_ippan.cell(row=6, column=58).value = '家屋被害額_50から99cm'
            ### ws_ippan.cell(row=6, column=59).value = '家屋被害額_100cm以上'
            ### ws_ippan.cell(row=6, column=60).value = '家屋被害額_半壊'
            ### ws_ippan.cell(row=6, column=61).value = '家屋被害額_全壊'
            ### ws_ippan.cell(row=6, column=62).value = '家庭用品自動車以外被害額_床下'
            ### ws_ippan.cell(row=6, column=63).value = '家庭用品自動車以外被害額_01から49cm'
            ### ws_ippan.cell(row=6, column=64).value = '家庭用品自動車以外被害額_50から99cm'
            ### ws_ippan.cell(row=6, column=65).value = '家庭用品自動車以外被害額_100cm以上'
            ### ws_ippan.cell(row=6, column=66).value = '家庭用品自動車以外被害額_半壊'
            ### ws_ippan.cell(row=6, column=67).value = '家庭用品自動車以外被害額_全壊'
            ### ws_ippan.cell(row=6, column=68).value = '家庭用品自動車被害額_床下'
            ### ws_ippan.cell(row=6, column=69).value = '家庭用品自動車被害額_01から49cm'
            ### ws_ippan.cell(row=6, column=70).value = '家庭用品自動車被害額_50から99cm'
            ### ws_ippan.cell(row=6, column=71).value = '家庭用品自動車被害額_100cm以上'
            ### ws_ippan.cell(row=6, column=72).value = '家庭用品自動車被害額_半壊'
            ### ws_ippan.cell(row=6, column=73).value = '家庭用品自動車被害額_全壊'
            ### ws_ippan.cell(row=6, column=74).value = '家庭応急対策費_代替活動費_床下'
            ### ws_ippan.cell(row=6, column=75).value = '家庭応急対策費_代替活動費_01から49cm'
            ### ws_ippan.cell(row=6, column=76).value = '家庭応急対策費_代替活動費_50から99cm'
            ### ws_ippan.cell(row=6, column=77).value = '家庭応急対策費_代替活動費_100cm以上'
            ### ws_ippan.cell(row=6, column=78).value = '家庭応急対策費_代替活動費_半壊'
            ### ws_ippan.cell(row=6, column=79).value = '家庭応急対策費_代替活動費_全壊'
            ### ws_ippan.cell(row=6, column=80).value = '家庭応急対策費_清掃費_床下'
            ### ws_ippan.cell(row=6, column=81).value = '家庭応急対策費_清掃費_01から49cm'
            ### ws_ippan.cell(row=6, column=82).value = '家庭応急対策費_清掃費_50から99cm'
            ### ws_ippan.cell(row=6, column=83).value = '家庭応急対策費_清掃費_100cm以上'
            ### ws_ippan.cell(row=6, column=84).value = '家庭応急対策費_清掃費_半壊'
            ### ws_ippan.cell(row=6, column=85).value = '家庭応急対策費_清掃費_全壊'
            ### ws_ippan.cell(row=6, column=86).value = '事業所被害額_償却資産被害額_床下'
            ### ws_ippan.cell(row=6, column=87).value = '事業所被害額_償却資産被害額_01から49cm'
            ### ws_ippan.cell(row=6, column=88).value = '事業所被害額_償却資産被害額_50から99cm'
            ### ws_ippan.cell(row=6, column=89).value = '事業所被害額_償却資産被害額_100cm以上'
            ### ws_ippan.cell(row=6, column=90).value = '事業所被害額_償却資産被害額_全壊'
            ### ws_ippan.cell(row=6, column=91).value = '事業所被害額_在庫資産被害額_床下'
            ### ws_ippan.cell(row=6, column=92).value = '事業所被害額_在庫資産被害額_01から49cm'
            ### ws_ippan.cell(row=6, column=93).value = '事業所被害額_在庫資産被害額_50から99cm'
            ### ws_ippan.cell(row=6, column=94).value = '事業所被害額_在庫資産被害額_100cm以上'
            ### ws_ippan.cell(row=6, column=95).value = '事業所被害額_在庫資産被害額_全壊'
            ### ws_ippan.cell(row=6, column=96).value = '事業所被害額_営業停止に伴う被害額_床下'
            ### ws_ippan.cell(row=6, column=97).value = '事業所被害額_営業停止に伴う被害額_01から49cm'
            ...
            ### ws_ippan.cell(row=7, column=56).value = ''
            ...
            ippan_view_list = IPPAN_VIEW.objects.raw("""
                ...
                WHERE 
                    IV1.city_code=%s AND IV1.deleted_at IS NULL 
                ORDER BY CAST(IV1.suigai_id AS INTEGER), CAST(IV1.ippan_id AS INTEGER)""", [
            ...
            if ippan_view_list:
                for i, ippan in enumerate(ippan_view_list):
                    ...
                    if ippan.house_summary_lv01_49 is not None and len(str(ippan.house_summary_lv01_49)) > 0:
                        ws_ippan.cell(row=8+i, column=57).value = str(ippan.house_summary_lv01_49)

                    if ippan.house_summary_lv50_99 is not None and len(str(ippan.house_summary_lv50_99)) > 0:
                        ws_ippan.cell(row=8+i, column=58).value = str(ippan.house_summary_lv50_99)

                    if ippan.house_summary_lv100 is not None and len(str(ippan.house_summary_lv100)) > 0:
                        ws_ippan.cell(row=8+i, column=59).value = str(ippan.house_summary_lv100)

                    if ippan.house_summary_half is not None and len(str(ippan.house_summary_half)) > 0:
                        ws_ippan.cell(row=8+i, column=60).value = str(ippan.house_summary_half)

                    if ippan.house_summary_full is not None and len(str(ippan.house_summary_full)) > 0:
                        ws_ippan.cell(row=8+i, column=61).value = str(ippan.house_summary_full)

                    if ippan.household_summary_lv00 is not None and len(str(ippan.household_summary_lv00)) > 0:
                        ws_ippan.cell(row=8+i, column=62).value = str(ippan.household_summary_lv00)

                    if ippan.household_summary_lv01_49 is not None and len(str(ippan.household_summary_lv01_49)) > 0:
                        ws_ippan.cell(row=8+i, column=63).value = str(ippan.household_summary_lv01_49)

                    if ippan.household_summary_lv50_99 is not None and len(str(ippan.household_summary_lv50_99)) > 0:
                        ws_ippan.cell(row=8+i, column=64).value = str(ippan.household_summary_lv50_99)

                    if ippan.household_summary_lv100 is not None and len(str(ippan.household_summary_lv100)) > 0:
                        ws_ippan.cell(row=8+i, column=65).value = str(ippan.household_summary_lv100)

                    if ippan.household_summary_half is not None and len(str(ippan.household_summary_half)) > 0:
                        ws_ippan.cell(row=8+i, column=66).value = str(ippan.household_summary_half)

                    if ippan.household_summary_full is not None and len(str(ippan.household_summary_full)) > 0:
                        ws_ippan.cell(row=8+i, column=67).value = str(ippan.household_summary_full)

                    if ippan.car_summary_lv00 is not None and len(str(ippan.car_summary_lv00)) > 0:
                        ws_ippan.cell(row=8+i, column=68).value = str(ippan.car_summary_lv00)

                    if ippan.car_summary_lv01_49 is not None and len(str(ippan.car_summary_lv01_49)) > 0:
                        ws_ippan.cell(row=8+i, column=69).value = str(ippan.car_summary_lv01_49)

                    if ippan.car_summary_lv50_99 is not None and len(str(ippan.car_summary_lv50_99)) > 0:
                        ws_ippan.cell(row=8+i, column=70).value = str(ippan.car_summary_lv50_99)

                    if ippan.car_summary_lv100 is not None and len(str(ippan.car_summary_lv100)) > 0:
                        ws_ippan.cell(row=8+i, column=71).value = str(ippan.car_summary_lv100)

                    if ippan.car_summary_half is not None and len(str(ippan.car_summary_half)) > 0:
                        ws_ippan.cell(row=8+i, column=72).value = str(ippan.car_summary_half)

                    if ippan.car_summary_full is not None and len(str(ippan.car_summary_full)) > 0:
                        ws_ippan.cell(row=8+i, column=73).value = str(ippan.car_summary_full)

                    if ippan.house_alt_summary_lv00 is not None and len(str(ippan.house_alt_summary_lv00)) > 0:
                        ws_ippan.cell(row=8+i, column=74).value = str(ippan.house_alt_summary_lv00)

                    if ippan.house_alt_summary_lv01_49 is not None and len(str(ippan.house_alt_summary_lv01_49)) > 0:
                        ws_ippan.cell(row=8+i, column=75).value = str(ippan.house_alt_summary_lv01_49)

                    if ippan.house_alt_summary_lv50_99 is not None and len(str(ippan.house_alt_summary_lv50_99)) > 0:
                        ws_ippan.cell(row=8+i, column=76).value = str(ippan.house_alt_summary_lv50_99)

                    if ippan.house_alt_summary_lv100 is not None and len(str(ippan.house_alt_summary_lv100)) > 0:
                        ws_ippan.cell(row=8+i, column=77).value = str(ippan.house_alt_summary_lv100)

                    if ippan.house_alt_summary_half is not None and len(str(ippan.house_alt_summary_half)) > 0:
                        ws_ippan.cell(row=8+i, column=78).value = str(ippan.house_alt_summary_half)

                    if ippan.house_alt_summary_full is not None and len(str(ippan.house_alt_summary_full)) > 0:
                        ws_ippan.cell(row=8+i, column=79).value = str(ippan.house_alt_summary_full)

                    if ippan.house_clean_summary_lv00 is not None and len(str(ippan.house_clean_summary_lv00)) > 0:
                        ws_ippan.cell(row=8+i, column=80).value = str(ippan.house_clean_summary_lv00)

                    if ippan.house_clean_summary_lv01_49 is not None and len(str(ippan.house_clean_summary_lv01_49)) > 0:
                        ws_ippan.cell(row=8+i, column=81).value = str(ippan.house_clean_summary_lv01_49)

                    if ippan.house_clean_summary_lv50_99 is not None and len(str(ippan.house_clean_summary_lv50_99)) > 0:
                        ws_ippan.cell(row=8+i, column=82).value = str(ippan.house_clean_summary_lv50_99)

                    if ippan.house_clean_summary_lv100 is not None and len(str(ippan.house_clean_summary_lv100)) > 0:
                        ws_ippan.cell(row=8+i, column=83).value = str(ippan.house_clean_summary_lv100)

                    if ippan.house_clean_summary_half is not None and len(str(ippan.house_clean_summary_half)) > 0:
                        ws_ippan.cell(row=8+i, column=84).value = str(ippan.house_clean_summary_half)

                    if ippan.house_clean_summary_full is not None and len(str(ippan.house_clean_summary_full)) > 0:
                        ws_ippan.cell(row=8+i, column=85).value = str(ippan.house_clean_summary_full)

                    if ippan.office_dep_summary_lv00 is not None and len(str(ippan.office_dep_summary_lv00)) > 0:
                        ws_ippan.cell(row=8+i, column=86).value = str(ippan.office_dep_summary_lv00)

                    if ippan.office_dep_summary_lv01_49 is not None and len(str(ippan.office_dep_summary_lv01_49)) > 0:
                        ws_ippan.cell(row=8+i, column=87).value = str(ippan.office_dep_summary_lv01_49)

                    if ippan.office_dep_summary_lv50_99 is not None and len(str(ippan.office_dep_summary_lv50_99)) > 0:
                        ws_ippan.cell(row=8+i, column=88).value = str(ippan.office_dep_summary_lv50_99)

                    if ippan.office_dep_summary_lv100 is not None and len(str(ippan.office_dep_summary_lv100)) > 0:
                        ws_ippan.cell(row=8+i, column=89).value = str(ippan.office_dep_summary_lv100)

                    if ippan.office_dep_summary_full is not None and len(str(ippan.office_dep_summary_full)) > 0:
                        ws_ippan.cell(row=8+i, column=90).value = str(ippan.office_dep_summary_full)

                    if ippan.office_inv_summary_lv00 is not None and len(str(ippan.office_inv_summary_lv00)) > 0:
                        ws_ippan.cell(row=8+i, column=91).value = str(ippan.office_inv_summary_lv00)

                    if ippan.office_inv_summary_lv01_49 is not None and len(str(ippan.office_inv_summary_lv01_49)) > 0:
                        ws_ippan.cell(row=8+i, column=92).value = str(ippan.office_inv_summary_lv01_49)

                    if ippan.office_inv_summary_lv50_99 is not None and len(str(ippan.office_inv_summary_lv50_99)) > 0:
                        ws_ippan.cell(row=8+i, column=93).value = str(ippan.office_inv_summary_lv50_99)

                    if ippan.office_inv_summary_lv100 is not None and len(str(ippan.office_inv_summary_lv100)) > 0:
                        ws_ippan.cell(row=8+i, column=94).value = str(ippan.office_inv_summary_lv100)

                    if ippan.office_inv_summary_full is not None and len(str(ippan.office_inv_summary_full)) > 0:
                        ws_ippan.cell(row=8+i, column=95).value = str(ippan.office_inv_summary_full)

                    if ippan.office_sus_summary_lv00 is not None and len(str(ippan.office_sus_summary_lv00)) > 0:
                        ws_ippan.cell(row=8+i, column=96).value = str(ippan.office_sus_summary_lv00)

                    if ippan.office_sus_summary_lv01_49 is not None and len(str(ippan.office_sus_summary_lv01_49)) > 0:
                        ws_ippan.cell(row=8+i, column=97).value = str(ippan.office_sus_summary_lv01_49)

                    if ippan.office_sus_summary_lv50_99 is not None and len(str(ippan.office_sus_summary_lv50_99)) > 0:
                        ws_ippan.cell(row=8+i, column=98).value = str(ippan.office_sus_summary_lv50_99)

                    if ippan.office_sus_summary_lv100 is not None and len(str(ippan.office_sus_summary_lv100)) > 0:
                        ws_ippan.cell(row=8+i, column=99).value = str(ippan.office_sus_summary_lv100)

                    if ippan.office_sus_summary_full is not None and len(str(ippan.office_sus_summary_full)) > 0:
                        ws_ippan.cell(row=8+i, column=100).value = str(ippan.office_sus_summary_full)

                    if ippan.office_stg_summary_lv00 is not None and len(str(ippan.office_stg_summary_lv00)) > 0:
                        ws_ippan.cell(row=8+i, column=101).value = str(ippan.office_stg_summary_lv00)

                    if ippan.office_stg_summary_lv01_49 is not None and len(str(ippan.office_stg_summary_lv01_49)) > 0:
                        ws_ippan.cell(row=8+i, column=102).value = str(ippan.office_stg_summary_lv01_49)

                    if ippan.office_stg_summary_lv50_99 is not None and len(str(ippan.office_stg_summary_lv50_99)) > 0:
                        ws_ippan.cell(row=8+i, column=103).value = str(ippan.office_stg_summary_lv50_99)

                    if ippan.office_stg_summary_lv100 is not None and len(str(ippan.office_stg_summary_lv100)) > 0:
                        ws_ippan.cell(row=8+i, column=104).value = str(ippan.office_stg_summary_lv100)

                    if ippan.office_stg_summary_full is not None and len(str(ippan.office_stg_summary_full)) > 0:
                        ws_ippan.cell(row=8+i, column=105).value = str(ippan.office_stg_summary_full)

                    if ippan.farmer_fisher_dep_summary_lv00 is not None and len(str(ippan.farmer_fisher_dep_summary_lv00)) > 0:
                        ws_ippan.cell(row=8+i, column=106).value = str(ippan.farmer_fisher_dep_summary_lv00)

                    if ippan.farmer_fisher_dep_summary_lv01_49 is not None and len(str(ippan.farmer_fisher_dep_summary_lv01_49)) > 0:
                        ws_ippan.cell(row=8+i, column=107).value = str(ippan.farmer_fisher_dep_summary_lv01_49)

                    if ippan.farmer_fisher_dep_summary_lv50_99 is not None and len(str(ippan.farmer_fisher_dep_summary_lv50_99)) > 0:
                        ws_ippan.cell(row=8+i, column=108).value = str(ippan.farmer_fisher_dep_summary_lv50_99)

                    if ippan.farmer_fisher_dep_summary_lv100 is not None and len(str(ippan.farmer_fisher_dep_summary_lv100)) > 0:
                        ws_ippan.cell(row=8+i, column=109).value = str(ippan.farmer_fisher_dep_summary_lv100)

                    if ippan.farmer_fisher_dep_summary_full is not None and len(str(ippan.farmer_fisher_dep_summary_full)) > 0:
                        ws_ippan.cell(row=8+i, column=110).value = str(ippan.farmer_fisher_dep_summary_full)

                    if ippan.farmer_fisher_inv_summary_lv00 is not None and len(str(ippan.farmer_fisher_inv_summary_lv00)) > 0:
                        ws_ippan.cell(row=8+i, column=111).value = str(ippan.farmer_fisher_inv_summary_lv00)

                    if ippan.farmer_fisher_inv_summary_lv01_49 is not None and len(str(ippan.farmer_fisher_inv_summary_lv01_49)) > 0:
                        ws_ippan.cell(row=8+i, column=112).value = str(ippan.farmer_fisher_inv_summary_lv01_49)

                    if ippan.farmer_fisher_inv_summary_lv50_99 is not None and len(str(ippan.farmer_fisher_inv_summary_lv50_99)) > 0:
                        ws_ippan.cell(row=8+i, column=113).value = str(ippan.farmer_fisher_inv_summary_lv50_99)

                    if ippan.farmer_fisher_inv_summary_lv100 is not None and len(str(ippan.farmer_fisher_inv_summary_lv100)) > 0:
                        ws_ippan.cell(row=8+i, column=114).value = str(ippan.farmer_fisher_inv_summary_lv100)

                    if ippan.farmer_fisher_inv_summary_full is not None and len(str(ippan.farmer_fisher_inv_summary_full)) > 0:
                        ws_ippan.cell(row=8+i, column=115).value = str(ippan.farmer_fisher_inv_summary_full)

                    if ippan.office_alt_summary_lv00 is not None and len(str(ippan.office_alt_summary_lv00)) > 0:
                        ws_ippan.cell(row=8+i, column=116).value = str(ippan.office_alt_summary_lv00)

                    if ippan.office_alt_summary_lv01_49 is not None and len(str(ippan.office_alt_summary_lv01_49)) > 0:
                        ws_ippan.cell(row=8+i, column=117).value = str(ippan.office_alt_summary_lv01_49)

                    if ippan.office_alt_summary_lv50_99 is not None and len(str(ippan.office_alt_summary_lv50_99)) > 0:
                        ws_ippan.cell(row=8+i, column=118).value = str(ippan.office_alt_summary_lv50_99)

                    if ippan.office_alt_summary_lv100 is not None and len(str(ippan.office_alt_summary_lv100)) > 0:
                        ws_ippan.cell(row=8+i, column=119).value = str(ippan.office_alt_summary_lv100)

                    if ippan.office_alt_summary_half is not None and len(str(ippan.office_alt_summary_half)) > 0:
                        ws_ippan.cell(row=8+i, column=120).value = str(ippan.office_alt_summary_half)

                    if ippan.office_alt_summary_full is not None and len(str(ippan.office_alt_summary_full)) > 0:
