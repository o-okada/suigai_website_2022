...
# -*- coding: utf-8 -*-
###############################################################################
### ファイル名：P0900Action/management/commands/action_C01_download_ippan_city.py
### C01：ダウンロード
###############################################################################
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            ###################################################################
            reset_log()
            print_log('[INFO] P0900Action.action_C01_download_ippan_city.handle()関数が開始しました。', 'INFO')
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 STEP 1/13.', 'DEBUG')
            ...
            ###################################################################
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 STEP 2/13.', 'DEBUG')
            ...
            if trigger_list is None:
                print_log('[INFO] P0900Action.action_C01_download_ippan_city.handle()関数が正常終了しました。', 'INFO')
                return 0
            ...
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 trigger_list[0].trigger_id = {}'.format(trigger_list[0].trigger_id), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 trigger_list[0].suigai_id = {}'.format(trigger_list[0].suigai_id), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 trigger_list[0].city_code = {}'.format(trigger_list[0].city_code), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 trigger_list[0].ken_code = {}'.format(trigger_list[0].ken_code), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 trigger_list[0].download_file_path = {}'.format(trigger_list[0].download_file_path), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 trigger_list[0].download_file_name = {}'.format(trigger_list[0].download_file_name), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 trigger_list[0].upload_file_path = {}'.format(trigger_list[0].upload_file_path), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 trigger_list[0].upload_file_name = {}'.format(trigger_list[0].upload_file_name), 'DEBUG')
    
            ###################################################################
            ### DBアクセス処理(0020)
            ### マスタデータを取得する。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 STEP 3/13.', 'DEBUG')
            ### 1000: 建物区分シート
            ### 1010: 都道府県シート
            ...
            ### ダウンロード用ファイルパスをセットする。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 STEP 4/13.', 'DEBUG')
            ...
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 download_file_path = {}'.format(download_file_path), 'DEBUG')
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 download_file_name = {}'.format(download_file_name), 'DEBUG')

            ###################################################################
            ### EXCEL入出力処理(0040)
            ### ワークシートを局所変数にセットする。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 STEP 5/13.', 'DEBUG')
            ...
            ###################################################################
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 STEP 6/13.', 'DEBUG')
            ...
            ### マスタ用のシートに値をセットする。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 STEP 7/13.', 'DEBUG')
            ### 1000: 建物区分シート
            ...
            ###################################################################
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 STEP 8/13.', 'DEBUG')
            ### 1020: 市区町村VLOOKUP
            ...
            ###################################################################
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 STEP 9/13.', 'DEBUG')
            ...
            ### EXCELのセルに、値を埋め込む。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 STEP 10/13.', 'DEBUG')
            ...
            ###################################################################
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 STEP 11/13.', 'DEBUG')
            ...
            ### トリガーデータを更新する。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 STEP 12/13.', 'DEBUG')
            ...
            try:
                ...
                print_log('[ERROR] P0900Action.action_C01_download_ippan_city.handle()関数 {}'.format(sys.exc_info()[0]), 'ERROR')
            ...
            ### 戻り値を戻す。
            ###################################################################
            print_log('[DEBUG] P0900Action.action_C01_download_ippan_city.handle()関数 STEP 13/13.', 'DEBUG')
            print_log('[INFO] P0900Action.action_C01_download_ippan_city.handle()関数が正常終了しました。', 'INFO')
            return 0
        except:
            print_log('[ERROR] P0900Action.action_C01_download_ippan_city.handle()関数 {}'.format(sys.exc_info()[0]), 'ERROR')
            print_log('[ERROR] P0900Action.action_C01_download_ippan_city.handle()関数でエラーが発生しました。', 'ERROR')
            print_log('[ERROR] P0900Action.action_C01_download_ippan_city.handle()関数が異常終了しました。', 'ERROR')
            return 8
