    ...
    if suigai_id == 0:
        trigger_list = TRIGGER.objects.raw("""
            SELECT 
                ...
                TO_CHAR(timezone('JST', TR1.published_at::timestamptz), 'mm/dd') AS published_at, 
                TO_CHAR(timezone('JST', TR1.consumed_at::timestamptz), 'mm/dd') AS consumed_at, 
                TO_CHAR(timezone('JST', TR1.deleted_at::timestamptz), 'mm/dd') AS deleted_at, 
